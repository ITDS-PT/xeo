...
public final class EmailValidator 
{
    ...
    {
       System.out.print(checkEmail("geral@ctrancoso.mailpt"));
    }
...
String pattern3 = "^(([\\w-]+\\.)+[\\w-]+|([a-zA-Z]{1}|[\\w-]{2,}))@" + 
    "((([0-1]?[0-9]{1,2}|2{1}[0-5]{2})\\.([0-1]?[0-9]{1,2}|2{1}[0-5]{2})\\." +
    "([0-1]?[0-9]{1,2}|2{1}[0-5]{2})\\.([0-1]?[0-9]{1,2}|2{1}[0-5]{2})){1}|" + 
    "((([0-9]+[a-zA-Z]+[\\w-])|([a-zA-Z]+[\\w-]))+\\.)+[a-zA-Z]{2,4})$";

String pattern4 = "^(([^<>;[\\]\\\\.,;:@\"]+(\\.[^<>[\\]\\\\.,;:@\"]+)*)|(.*))@"+
"(((([0-9]+[a-z]([-a-z0-9]*[a-z0-9])?)|([a-z]([-a-z0-9]*[a-z0-9]"+
")?))|(#[0-9]+)|(\\[((([01]?[0-9]{0,2})|(2(([0-4][0-9])|(5[0-5]))"+
"))\\.){3}(([01]?[0-9]{0,2})|(2(([0-4][0-9])|(5[0-5]))))\\]))\\.)*"+
"((([0-9]+[a-z]([-a-z0-9]*[a-z0-9])?)|([a-z]([-a-z0-9]*[a-z0-9])?))|"+
"(#[0-9]+)|(\\[((([01]?[0-9]{0,2})|(2(([0-4][0-9])|(5[0-5]))))\\.){3}"+
"(([01]?[0-9]{0,2})|(2(([0-4][0-9])|(5[0-5]))))\\]))$";       
       
           String pattern = "^(([^<>[\\]\\\\.,;:\\s@\\\"]+(\\.[^<>[\\]\\\\.,;:\\s@\\\"]+)*)|(.*))@((\\[[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\])|(([a-zA-Z\\-0-9]+\\.)+[a-zA-Z]{2,}))$";
           RegularExpression regexp = new RegularExpression( pattern4 );
