...
public class Mail
{
    ...
    private boolean readAccountUseSSL = false;
    private String  readAccountProtocolPort;
    ...
    public boolean getReadAccountUseSSL() {
    	return this.readAccountUseSSL;
    }
    
    public String getReadAccountProtocolPort() {
		return readAccountProtocolPort;
	}
    
    public void setReadAccountProtocolPort(String readAccountProtocolPort) {
		this.readAccountProtocolPort = readAccountProtocolPort;
	}
    
    public void setReadAccountUseSSL(boolean readAccountUseSSL) {
		this.readAccountUseSSL = readAccountUseSSL;
	}
        ...
        throws RemoteException, MessagingException, IOException
    {
         ...
         catch (Exception e)
        {
            ...
            logger.error("Erro reading mailbox [ " + this.p_POPHost +"][" + this.p_UserName + "] Folder [" + foldername + "]" , e);
            //   e.printStackTrace();
            if (folder != null)
            {
                folder.close(false);
