 ...
 * @since
 */
public class SavedExplorers implements Element {
    private String code;
     ...
     * @since
     */
    public SavedExplorers(String code) {
        this.code = code;
    }

    public SavedExplorers(Explorer tree) {
        this.tree = tree;
    }
    ...
    public void writeHTML(PrintWriter out,docHTML docHTML, docHTML_controler docList, PageController control)
        ...
        HTMLBuilder.writeSavedExplorer(out, this,docHTML, docList, control);
    }

    public String getHTML(docHTML docHTML, docHTML_controler docList,PageController control)
        throws IOException, boRuntimeException {
        return HTMLBuilder.getSavedExplorerHTML(this,docHTML, docList, control);
    }
}
