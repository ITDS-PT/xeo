 ...
 * @version 1.0
 */
public final class exportObject  implements Serializable {
     ...
     */ 
    public exportObject(boObject object, String[] attrNames , boolean allAtt) throws boRuntimeException
    {
     ...
     */ 
    public exportObject(boObject object, String[] attrNames , boolean allAtt, Hashtable booleanPattern) throws boRuntimeException
    {    
        ...
        for (int i = 0; i < dat.size(); i++){
            ...
            if (attr.type == attrData.STRING_TYPE){
                ...
                if(csvPos(attr.pathName) == -1){
                    ...
                    csv.parent = par;
                    insertAt(csv.data,attr.getCSVDataString(), nivel);
