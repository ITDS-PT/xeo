 ...
 * @since
 */
public class OracleWriterAdapter implements WriterAdapter
{
    //logger
    private static Logger logger = Logger.getLogger("netgest.bo.data.oracle.OracleWriterAdapter");
    /**
     *
     * @since
     */
    ...
    public OracleWriterAdapter(String dmlds)
    {
        dmlDs = dmlds;
    }
