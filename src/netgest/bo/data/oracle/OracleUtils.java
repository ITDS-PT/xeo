 ...
 * @since 
 */
public class OracleUtils  implements DriverUtils
{
    /**
     * 
     * @since 
    ...
    public OracleUtils( String dmlds )
    {
        p_ds = dmlds;
    }
    public DataSetMetaData getMetaDataForSelect( EboContext ctx, String query , ArrayList arguments ) 
    {
        ...
        OracleReaderAdapter orclreader = null ;
        try
        {
            orclreader = new OracleReaderAdapter( p_ds );
            orclreader.executeQuery( ctx, query, arguments );
	...
	public byte getQueryLimitStatementPosition() {
		return DriverUtils.QUERY_LIMIT_ON_WHERE_CLAUSE;
	}
