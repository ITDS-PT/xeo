...
public class BDReport2
{
     ...
     * @since
     */
    public BDReport2(EboContext ebo, String packageName, String fileName)
    {
        this.ebo = ebo;
    ...
    public String createHtmlReport() throws boRuntimeException
    {
        ...
        try
        {
            ...
            toRet = createHtmlReport(ebo, toReport);
        }
        catch (Exception e)
        {
            e.printStackTrace();
...
//            }
    ...
    private String createHtmlReport(EboContext ebo, ArrayList files)
        throws Exception
    {
        File xboObject = null;
        boDefHandler bodef;
