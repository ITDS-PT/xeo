 ...
 * @since
 */
public class MapType1Def
{
    public static final Logger logger = Logger.getLogger( MapType1Def.class.getName() );

    private static final Object DUMMY = new Object();
    private String p_defaultDS = "DATA";
    private String p_defaultSchema = "";
    private MapType1Def.ObjectDataSource p_readerds;
    private MapType1Def.ObjectDataSource p_writerds;
    private MapType1Def.ObjectDataSource p_objectds;
    ...
    private MapType1Def.ChangeDetectionHandler p_tabletriggers   = null;
    private MapType1Def.ChangeDetectionHandler p_tablechecksums  = null;
    
    private static Hashtable p_cacheDefs        = new Hashtable();
    private static Hashtable p_cacheUndepDefs   = new Hashtable();
    
    
    public MapType1Def(boDefHandler parent, XMLDocument xml)
    {
        p_bodef = parent;
        ...
        try
        {
            if (xml != null)
            {
                ...
                if( cd != null )
                {
                    ...
                    if( xnode != null )
                    {
                        p_tabletriggers = new MapType1Def.ChangeDetectionHandler( xnode );
                    }
                    
                    xnode = (XMLNode)cd.selectSingleNode("checksum");
                    if( xnode != null )
                    {
                        p_tablechecksums = new MapType1Def.ChangeDetectionHandler( xnode );
                    }
                }
            ...
            p_objectds = new MapType1Def.ObjectDataSource(new ngtXMLHandler((xml == null)
                        ? null
            ...
            p_readerds = new MapType1Def.ObjectDataSource(new ngtXMLHandler((xml == null)
                        ? null
                        : ((XMLNode) xml.getDocumentElement()).selectSingleNode(
                            "readers")), (byte) 0);
            p_writerds = new MapType1Def.ObjectDataSource(new ngtXMLHandler((xml == null)
                        ? null
                        : ((XMLNode) xml.getDocumentElement()).selectSingleNode(
                            "writers")), (byte) 1);
        }
    ...
    public MapType1Def.ChangeDetectionHandler getTriggers()
    {
    ...
    public MapType1Def.ChangeDetectionHandler getChecksums()
    {
     ...
     * @since
     */
    public static final MapType1Def getDataSourceDefinition(
        boDefHandler objectDef)
    {
        ...
        if( xret == null )
        {
            ...
            if (xfile.exists())
            {
                doc = ngtXMLUtils.loadXMLFile(boconf.getDeploymentDir() + boname +
                        boBuilder.TYPE_DS);
                xret = new MapType1Def(objectDef, doc);
        ...
        return xret instanceof MapType1Def?(MapType1Def)xret:null;
    }

    public static final MapType1Def getUndeployedDataSourceDefinition(
        boBuildRepository repository, boDefHandler objectDef)
    {
        ...
        if( obj == null )
        {
            ...
            if ((xfile != null) && xfile.exists())
            {
                ...
                obj = new MapType1Def(objectDef, doc);
        ...
        MapType1Def ret = (MapType1Def)obj;
    ...
    public final boolean haveMappingFields()
    {
        ...
        if( !this.isDefault() )
        {
            MapType1Def.ObjectDS[] ds = this.getObjectDataSources().getDataSources();
    ...
    public final MapType1Def.ObjectDataSource getReaderDataSource()
    {
        return p_readerds;
    }

    public final MapType1Def.ObjectDataSource getWriterDataSource()
    {
        return p_writerds;
    }

    public final MapType1Def.ObjectDataSource getObjectDataSources()
    {
        return p_objectds;
    }
    ...
    public class ObjectDataSource
    {
        ...
        private final void init()
        {
            ...
            if (p_node.getNode() != null)
            {
                ...
                {
                    MapType1Def.ObjectDS ds = new MapType1Def.ObjectDS(nodes[i], p_type);
            ...
            {
                p_ds.put("default", new MapType1Def.ObjectDS(null, p_type));
            }
        }
        ...
        public final MapType1Def.ObjectDS[] getDataSources()
        {
            String[] names = getDataSourcesNames();
            MapType1Def.ObjectDS[] ds = new MapType1Def.ObjectDS[names.length];
        ...
        public final MapType1Def.ObjectDS getDataSource(String name)
        {
    ...
    public class ObjectDS
    {
        ...
        private final void parse()
        {
            if (p_def != null)
            {
                ...
                p_mapping = new MapType1Def.Mapping(p_srcobject, p_def.getChildNode("mappings"));
            ...
            else
            {
                ...
                p_mapping = new MapType1Def.Mapping(p_srcobject);
            }
        }
