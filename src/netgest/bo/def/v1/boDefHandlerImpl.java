...
public class boDefHandlerImpl extends boDefHandler
{
    ...
    private boDefHandler[] p_businessImplements;
...
//        p_datasources = null;
        ...
        if (xnode != null)
        {
            ...
            if (xnode != null)
            {
                ...
                p_businessImplements = (boDefHandlerImpl[])intefs.toArray(new boDefHandlerImpl[(intefs.size())]);
            }
        }
