...
public class GarbageRemoverAgentBean extends XEOTimedObjectWrapper
    implements SessionBean
{

    private SessionContext _context;
    private static Logger logger = Logger.getLogger("netgest.bo.runtime.robots.ejbtimers.GarbageRemoverAgent");
        ...
        try
        {
            ...
            if (timedObject!=null)
            {
                if(timedObject.isActive() && !timedObject.isRunning())
                {
                    ...
                    GarbageRemoverAgentBussinessLogic logic = new GarbageRemoverAgentBussinessLogic(timedObject.getXEOApplication());
                    logic.execute();
