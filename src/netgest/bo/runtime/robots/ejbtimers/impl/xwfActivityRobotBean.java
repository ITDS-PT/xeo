...
public class xwfActivityRobotBean extends XEOTimedObjectWrapper
    implements SessionBean, TimedObject
{
    private SessionContext _context;
    private static Logger logger = Logger.getLogger("netgest.bo.runtime.robots.ejbtimers.xwfActivityRobot");
        ...
        try
        {
            ...
            if (timedObject!=null)
            {
                if(timedObject.isActive() && !timedObject.isRunning())
                {
                    ...
                    xwfActivityRobotBussinessLogic logic = new xwfActivityRobotBussinessLogic(timedObject.getXEOApplication());
                    logic.execute();
