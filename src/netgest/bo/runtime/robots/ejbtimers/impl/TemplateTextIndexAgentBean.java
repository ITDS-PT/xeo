...
public class TemplateTextIndexAgentBean extends XEOTimedObjectWrapper
    implements SessionBean, TimedObject
{

    private SessionContext _context;
    private static Logger logger = Logger.getLogger("netgest.bo.runtime.robots.ejbtimers.TemplateTextIndexAgent");
        ...
        try
        {
            ...
            if (timedObject!=null)
            {
                if(timedObject.isActive() && !timedObject.isRunning())
                {
                    ...
                    TemplateTextIndexAgentBussinessLogic logic = new TemplateTextIndexAgentBussinessLogic(timedObject.getXEOApplication());
                    logic.execute();
