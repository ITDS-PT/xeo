...
try {
    ...
    String strOnlyObjects   =request.getParameter("onlyBridge");
    boolean onlyBridge = "true".equals(strOnlyObjects);
    ...
    if(!"".equals(objectName))
    {
        ...
        javaScriptStr=netgest.bo.impl.document.merge.gestemp.presentation.AttributesTreeHelper.getJavaScriptTree( bodef , onlyObjects , true, extendObject,index, onlyBridge);
  ...
  {
   dialogArguments[0].value = attributes[number];
   window.close();
  }
