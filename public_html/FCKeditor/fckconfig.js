...
FCKConfig.attrParent='';
FCKConfig.bouiParent='';
FCKConfig.docID		='';
FCKConfig.objXeoName='';
...
//## ------------- Não modificar os nomes ------------- ##\\
FCKConfig.ToolbarSets["None"] = [
] ;

FCKConfig.ToolbarSets["Default"] = [
	['Source','-','Preview','-','Cut','Copy','Paste','-','Bold','Italic','Underline','JustifyLeft','JustifyCenter','JustifyRight','Outdent','Indent'],
...
FCKConfig.ToolbarSets["html"] = [
	['Source','-','Preview','-','Cut','Copy','Paste','-','Bold','Italic','Underline','Clear','JustifyLeft','JustifyCenter','JustifyRight','Outdent','Indent'],
	['FontName','FontSize','TextColor']
] ;

FCKConfig.ToolbarSets["advanced"] = [
	['Source','-','Preview','Cut','Copy','Paste','PasteText','PasteWord','-','Print','Find','Replace','-','SelectAll','RemoveFormat'],
	['Bold','Italic','Underline','Clear','StrikeThrough','-','Subscript','Superscript'],
	['TextColor','BGColor'],
...
FCKConfig.ToolbarSets["htmladvanced"] = [
	['Source','-','Templates','-','Clear','Cut','Copy','Paste','PasteText','PasteWord','-','Undo','Redo','-','Print','Find','Replace','SpellCheck','-','SelectAll','RemoveFormat'],
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript','TextColor','BGColor'],
	['Style','FontFormat','FontName','FontSize'],
	['OrderedList','UnorderedList','-','Outdent','Indent','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
	['Table','Rule','SpecialChar','Smiley'],
	['Flash','Image','XEOImage','Link','XEOLink','Unlink','Anchor']
] ;
...
FCKConfig.ToolbarSets["Full"] = [
	...
	['Link','XEOLink','Unlink','Anchor'],
	['Image','XEOImage','Flash','Table','Rule','Smiley','SpecialChar','PageBreak','UniversalKey'],
