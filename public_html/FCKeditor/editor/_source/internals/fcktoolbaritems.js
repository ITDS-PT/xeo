...
FCKToolbarItems.GetItem = function( itemName )
{
	...
	switch ( itemName )
	{
		...
		case 'Clear'			: oItem = new FCKToolbarButton( 'Clear'			, FCKLang.Clear ) ; break ;
		case 'XEOImage'			: oItem = new FCKToolbarButton( 'XEOImage'		, FCKLang.XEOImage ) ; break ;
		case 'XEOLink'			: oItem = new FCKToolbarButton( 'XEOLink'		, FCKLang.XEOLink ) ; break ;
