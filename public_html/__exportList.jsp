...
if(bosession== null) {
    ...
    boDefHandler xbodef = xtree.p_bodef;
...
*/        
    ...
    netgest.bo.utils.exportList export = new netgest.bo.utils.exportList(boctx, xtree);
       ...
       if(xsl!=null && !xsl.equals(""))
       {
        ...
        {  
            ...
            else
            {
              ...
              PrintStream xslOut = new PrintStream(outres, true, "ISO-8859-1");
