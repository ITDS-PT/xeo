...
{ 
  ...
  if (browserVersion > 0) 
    auxEv = "<a onclick='javascript:clickOnNode(\""+this.getID()+"\")'>" //se tiver href numa showmodal abre outra janela!!!!
  else 
    auxEv = "<a>" 
...
//    docW = docW + "<a href='" + this.hreference + "'  "
    ...
    if (browserVersion > 0) 
	  {
      docW = docW + "onClick='javascript:"+this.hreference.substr(11)+";clickOnFolder(\""+this.getID()+"\")'"
      }
    docW = docW + ">"
  } 
  else 
...
function blockStartHTML(idprefix) {
  ...
  if (browserVersion == 2) 
    ...
    docW = "<div " + idParam + " style='display:block;border-bottom:1px solid #CCCCCC;position:block;'>"
...
function highlightObjLink(nodeObj) {
  ...
  if (browserVersion == 1 || browserVersion == 3) {
    ...
    if (clickedDOMObj != null) {
		...
		clickedDOMObj.parentNode.style.backgroundColor="#B0C4DE";
        clickedDOMObj.parentNode.style.borderRight="1px solid #000080";
        clickedDOMObj.parentNode.style.borderTop="1px solid #000080";
        clickedDOMObj.parentNode.style.borderBottom="1px solid #000080";
        

        clickedDOMObj.parentNode.previousSibling.style.borderTop="1px solid #000080";
        clickedDOMObj.parentNode.previousSibling.style.borderBottom="1px solid #000080";
        clickedDOMObj.parentNode.previousSibling.style.borderLeft="1px solid #000080";
        
        clickedDOMObj.parentNode.previousSibling.style.backgroundColor="#B0C4DE";
		clickedDOMObj.focus();
