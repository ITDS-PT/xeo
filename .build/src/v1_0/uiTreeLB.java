...
public  class uiTreeLB extends uiObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeString xmlTree;    
    ...
    public uiTreeLB() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("uiTreeLB");
        ...
        atts.add(xmlTree = new netgest.bo.runtime.attributes.boAttributeString(this,"xmlTree"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( xmlTree.haveDefaultValue()) 
                {
                	if(xmlTree.defaultValue() != null)
                	{
                    	xmlTree._setValue(boConvertUtils.convertToString(xmlTree.defaultValue(), xmlTree));
                    }
                    else
                    {
                    	xmlTree._setValue(null);
                    }
                    xmlTree.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
    
            if("uiTreeLB".equals(this.getName()))
            {
