...
public  class xwfProgram extends boObject implements  Serializable {  
    ...
    public netgest.bo.runtime.attributes.boAttributeNumber programType;    
    ...
    public xwfProgram() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("xwfProgram");
        ...
        atts.add(new boBridgeMasterAttribute(this,this.getBoDefinition().getAttributeRef("versions")));  
        atts.add(new boBridgeMasterAttribute(this,this.getBoDefinition().getAttributeRef("share")));  
        atts.add(new boBridgeMasterAttribute(this,this.getBoDefinition().getAttributeRef("owners")));  
        ...
        atts.add(programType = new netgest.bo.runtime.attributes.boAttributeNumber(this,"programType"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( programType.haveDefaultValue()) 
                {
                	if(programType.defaultValue() != null)
                	{
                    	programType._setValue(boConvertUtils.convertToBigDecimal(programType.defaultValue(), programType));
                    }
                    else
                    {
                    	programType._setValue(null);
                    }
                    programType.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("xwfProgram".equals(this.getName()))
            {
    ...
    public bridgeHandler owners()
    {
        return getBridge("owners");        
    }
    ...
    public bridgeHandler getBridge( String bridgeName ) 
    {
        ...
        if( ret == null )
        {
        	...
        	if( bridgeName.equals("versions") && (ret=brig.get("versions"))==null )
        	{
            	brig.add( ret=new BridgeHandlerversions(new DataResultSet( getDataRow().getRecordChild( getEboContext() ,"versions") ) , this ) );        
        	}
        	...
        	if( bridgeName.equals("owners") && (ret=brig.get("owners"))==null )
        	{
            	brig.add( ret=new BridgeHandlerowners(new DataResultSet( getDataRow().getRecordChild( getEboContext() ,"owners") ) , this ) );        
        	}
    ...
    public final class BridgeHandlerversions extends bridgeHandler {
        ...
        public BridgeHandlerversions(DataResultSet data,boObject parent) {
            super("versions",
                  data,
                  parent.getBoDefinition().getAttributeRef("versions").getBridge().getChildFieldName(),
                  parent
                 );

            p_fatherfield = parent.getBoDefinition().getAttributeRef("versions").getBridge().getFatherFieldName();
            p_childfield  = parent.getBoDefinition().getAttributeRef("versions").getBridge().getChildFieldName();
...
//			  if( newval != null ) allow=allow && att.onBeforeAdd(new boEvent(att, att.EVENT_BEFORE_ADD,newval));
			  ...
			  if( att.fireBeforeChangeEvent( att, null, newval) ) 
			  {
                  ...
                  if(getParent().onChangeSubmit("versions"))
                  {
                      getParent().calculateFormula("versions");
                  }
...
//					att.onAfterChange(new boEvent(att,att.EVENT_AFTER_CHANGE,chgval,null));
		...
		{
			return new BridgeHanlderversionsRow( this, row );
		}

		public final class BridgeHanlderversionsRow extends boBridgeRow
		{
			public BridgeHanlderversionsRow( bridgeHandler bridge, netgest.bo.data.DataRow row )
			{
				super( bridge , row );
				addLine();
			}
			...
			public void addLine() 
			{
				...
				if(this.getAttribute("versions")==null)
					xatt.add( new Handlerversions( getParent(), this ) );
				
		
			
				if(this.getAttribute("active")==null)
					xatt.add( new Handleractive( getParent(), this ) );
...
return null;
        ...
        public final class Handlerversions extends BridgeObjAttributeHandler {
            public Handlerversions( boObject parent , boBridgeRow bridgerow ) {
                super( parent , bridgerow , bridgerow.getBridge().getDefAttribute().getName().equals("versions")?parent.getBoDefinition().getAttributeRef("versions"):bridgerow.getBridge().getDefAttribute().getBridge().getAttributeRef("versions") );
            }
            public void setValueString(String value) {
                try {
                    ...
                    if(getParent().onChangeSubmit("versions"))
                    {
                        ...
                        getParent().setCalculated(table, "versions");
                        getParent().calculateFormula(table, "versions");
                    }
                } catch (Exception e) {
            ...
            public String getValueString() throws boRuntimeException {
                try {
                    ...
                    String[] args = {getParent().getName(),"versions"};
            ...
            public void setValueFormula(Hashtable table, String[]dependence) throws boRuntimeException
            {
                ...
                {                       
                    if(getParent().isWaiting(table, "versions"))
                    {
                       getParent().setCalculated(table, "versions");
                       this.setValue(boConvertUtils.convertToBigDecimal(formula(), this), false );
                    }
                    else if(!getParent().isCalculated(table, "versions"))
                    {
                        getParent().setCalculated(table, "versions");
                ...
                else if(getParent().dependsFromWaiting(table, dependence))
                {
                    ...
                    {
                        getParent().clear(table, "versions"); 
                        this.setValue(boConvertUtils.convertToBigDecimal(formula(), this), false );
                    }
                }
                else
                {   
                    ...
                    if(getParent().onChangeSubmit("versions"))
                    {                 
                        getParent().setWaiting(table, "versions");
                        getParent().calculateFormula(new Hashtable(table), "versions");
                        //getParent().setCalculated(table, "versions");
                    }                    
                }
            }
            ...
            public void setValue(BigDecimal newval, boolean recalc) throws boRuntimeException 
            {
                ...
                if( recalc && getParent().onChangeSubmit("versions"))
                {
                    Hashtable table = new Hashtable();
                    getParent().setCalculated(table, "versions");
                    getParent().calculateFormula(table, "versions");
				...
				{
					getParent().getParentBridgeRow().getBridge().lineChanged("versions");
				}
            }
...
return null;
        ...
        public final class Handleractive extends BridgeAttributeHandler {

            private boolean isdbbinding=true;
            private String fieldvalue;
            private boBridgeRow p_bridgerow;

			public Handleractive(boObject parent, boBridgeRow bridgerow ) {
                super( parent , bridgerow ,bridgerow.getBridge().getDefAttribute().getBridge().getAttributeRef("active") );
            ...
            public String getValue() throws boRuntimeException {
                ...
                if(isdbbinding) {
					ret=p_bridgerow.getDataRow().getString("ACTIVE");
                } else {
                    ret = fieldvalue;
                }
            ...
            public void setValueFormula(Hashtable table, String[]dependence) throws boRuntimeException
            {
                if(getParent().alreadyCalculated(table, dependence)) 
                {                       
                    if(getParent().isWaiting(table, "active"))
                    {
                       getParent().setCalculated(table, "active");
                       setValue(boConvertUtils.convertToString(formula(), this), false );
                    }
                    else if(!getParent().isCalculated(table, "active"))
                    {
                        getParent().setCalculated(table, "active");
                ...
                {
                    if(getParent().onChangeSubmit("active"))
                    {
                        getParent().setCalculated(table, "active"); 
                    }
                    else
                    {
                        getParent().clear(table, "active"); 
                        setValue(boConvertUtils.convertToString(formula(), this), false );
                    } 
                }
                else
                {    
                    ...
                    if(getParent().onChangeSubmit("active"))
                    {
                        getParent().setWaiting(table, "active");
                        getParent().calculateFormula(new Hashtable(table), "active");
                        //getParent().setCalculated(table, "active");
                    }                    
                }
            }
            ...
            public void setValue(String newval, boolean recalc) throws boRuntimeException 
            {
                if (getParent().isCheckSecurity() && !this.hasRights())
                    	throw new boRuntimeException(Handleractive.class.getName() +
...
//                    if(newval==null && chgval!=null) allow =onBeforeRemove(new boEvent(this,EVENT_BEFORE_REMOVE,chgval));
                    ...
                    if ( fireBeforeChangeEvent( this, chgval, newval) )
                    {
                            if(canAlter(recalc?AttributeHandler.INPUT_FROM_USER:AttributeHandler.INPUT_FROM_INTERNAL))
                            {
                                ...
                                if( recalc && getParent().onChangeSubmit("active"))
                                {
                                    Hashtable table = new Hashtable();
                                    getParent().setCalculated(table, "active");
                                    getParent().calculateFormula(table, "active");
                                }
	                        
                                //vou verificar se o objecto se encontra numa bridge
                                if ( getParent().p_parentBridgeRow != null )
                                {
                                    getParent().getParentBridgeRow().getBridge().lineChanged("active");
                                }
...
//	                        onAfterChange(new boEvent(this,EVENT_AFTER_CHANGE,chgval,newval));
            ...
            public void _setValue(String newval) throws boRuntimeException {
                if(isdbbinding) {
                        ...
                        p_bridgerow.getDataRow().updateString("ACTIVE",newval);
                        getParent().setChanged(true);
                        super.setValid();
...
return null;
    ...
    public final class BridgeHandlerowners extends bridgeHandler {
        private DataResultSet p_node;
        private String        p_fatherfield;
        private String        p_childfield;
        private boObject      p_parent;
        ...
        public BridgeHandlerowners(DataResultSet data,boObject parent) {
            super("owners",
                  data,
                  parent.getBoDefinition().getAttributeRef("owners").getBridge().getChildFieldName(),
                  parent
                 );

            p_fatherfield = parent.getBoDefinition().getAttributeRef("owners").getBridge().getFatherFieldName();
            p_childfield  = parent.getBoDefinition().getAttributeRef("owners").getBridge().getChildFieldName();
...
//			  if( newval != null ) allow=allow && att.onBeforeAdd(new boEvent(att, att.EVENT_BEFORE_ADD,newval));
			  ...
			  if( att.fireBeforeChangeEvent( att, null, newval) ) 
			  {
                  ...
                  if(getParent().onChangeSubmit("owners"))
                  {
                      getParent().calculateFormula("owners");
                  }
                  att.fireAfterChangeEvent( att, null, newval );
//				  if( newval != null ) att.onAfterAdd(new boEvent( att ,att.EVENT_AFTER_ADD,newval));
//				  att.onAfterChange(new boEvent( att ,att.EVENT_AFTER_CHANGE, null ,newval));
...
//					att.onAfterChange(new boEvent(att,att.EVENT_AFTER_CHANGE,chgval,null));
		...
		public boBridgeRow createRow( netgest.bo.data.DataRow row )
		{
			return new BridgeHanlderownersRow( this, row );
		}

		public final class BridgeHanlderownersRow extends boBridgeRow
		{
			public BridgeHanlderownersRow( bridgeHandler bridge, netgest.bo.data.DataRow row )
			{
				super( bridge , row );
				addLine();
			}
			...
			public void addLine() 
			{
				...
				if(this.getAttribute("owners")==null)
					xatt.add( new Handlerowners( getParent(), this ) );
...
return null;
        ...
        public final class Handlerowners extends BridgeObjAttributeHandler {
            public Handlerowners( boObject parent , boBridgeRow bridgerow ) {
                super( parent , bridgerow , bridgerow.getBridge().getDefAttribute().getName().equals("owners")?parent.getBoDefinition().getAttributeRef("owners"):bridgerow.getBridge().getDefAttribute().getBridge().getAttributeRef("owners") );
            }
            public void setValueString(String value) {
                try {
                    this.setValue(boConvertUtils.convertToBigDecimal(value,this));
                    ...
                    {
                        Hashtable table = new Hashtable();                    
                        getParent().setCalculated(table, "owners");
                        getParent().calculateFormula(table, "owners");
                    }
                } catch (Exception e) {
                    super.setInvalid(e.getMessage(),value);
                }
            ...
            public String getValueString() throws boRuntimeException {
                try {
                    ...
                    String[] args = {getParent().getName(),"owners"};
                    throw new boRuntimeException(this.getClass().getName()+".load(EboContext,long)","BO-3003",e,args);
                }
            }
            ...
            public void setValueFormula(Hashtable table, String[]dependence) throws boRuntimeException
            {
                if(getParent().alreadyCalculated(table, dependence)) 
                {                       
                    if(getParent().isWaiting(table, "owners"))
                    {
                       getParent().setCalculated(table, "owners");
                       this.setValue(boConvertUtils.convertToBigDecimal(formula(), this), false );
                    }
                    else if(!getParent().isCalculated(table, "owners"))
                    {
                        getParent().setCalculated(table, "owners");
                        this.setValue(boConvertUtils.convertToBigDecimal(formula(), this), table );
                    }
                ...
                {   
                    ...
                    if(getParent().onChangeSubmit("owners"))
                    {                 
                        getParent().setWaiting(table, "owners");
                        getParent().calculateFormula(new Hashtable(table), "owners");
                        //getParent().setCalculated(table, "owners");
                    }                    
                }
            }
            ...
            public void setValue(BigDecimal newval, boolean recalc) throws boRuntimeException 
            {
                ...
                if( recalc && getParent().onChangeSubmit("owners"))
                {
                    Hashtable table = new Hashtable();
                    getParent().setCalculated(table, "owners");
                    getParent().calculateFormula(table, "owners");
				...
				if ( getParent().p_parentBridgeRow != null )
				{
					getParent().getParentBridgeRow().getBridge().lineChanged("owners");
				}
            }
