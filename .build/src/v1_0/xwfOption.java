...
public  class xwfOption extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeString labelOption;    
    public netgest.bo.runtime.attributes.boAttributeString descriptionOption;    
    public netgest.bo.runtime.attributes.boAttributeString codeOption;    
    public netgest.bo.runtime.attributes.boAttributeString availableWhen;    
    public netgest.bo.runtime.attributes.boAttributeString disableWhen;    
    ...
    public xwfOption() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("xwfOption");
        ...
        atts.add(labelOption = new netgest.bo.runtime.attributes.boAttributeString(this,"labelOption"));
        
        atts.add(descriptionOption = new netgest.bo.runtime.attributes.boAttributeString(this,"descriptionOption"));
        
        atts.add(codeOption = new netgest.bo.runtime.attributes.boAttributeString(this,"codeOption"));
        
        atts.add(availableWhen = new netgest.bo.runtime.attributes.boAttributeString(this,"availableWhen"));
        
        atts.add(disableWhen = new netgest.bo.runtime.attributes.boAttributeString(this,"disableWhen"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( labelOption.haveDefaultValue()) 
                {
                	if(labelOption.defaultValue() != null)
                	{
                    	labelOption._setValue(boConvertUtils.convertToString(labelOption.defaultValue(), labelOption));
                    }
                    else
                    {
                    	labelOption._setValue(null);
                    }
                    labelOption.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( descriptionOption.haveDefaultValue()) 
                {
                	if(descriptionOption.defaultValue() != null)
                	{
                    	descriptionOption._setValue(boConvertUtils.convertToString(descriptionOption.defaultValue(), descriptionOption));
                    }
                    else
                    {
                    	descriptionOption._setValue(null);
                    }
                    descriptionOption.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( codeOption.haveDefaultValue()) 
                {
                	if(codeOption.defaultValue() != null)
                	{
                    	codeOption._setValue(boConvertUtils.convertToString(codeOption.defaultValue(), codeOption));
                    }
                    else
                    {
                    	codeOption._setValue(null);
                    }
                    codeOption.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( availableWhen.haveDefaultValue()) 
                {
                	if(availableWhen.defaultValue() != null)
                	{
                    	availableWhen._setValue(boConvertUtils.convertToString(availableWhen.defaultValue(), availableWhen));
                    }
                    else
                    {
                    	availableWhen._setValue(null);
                    }
                    availableWhen.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( disableWhen.haveDefaultValue()) 
                {
                	if(disableWhen.defaultValue() != null)
                	{
                    	disableWhen._setValue(boConvertUtils.convertToString(disableWhen.defaultValue(), disableWhen));
                    }
                    else
                    {
                    	disableWhen._setValue(null);
                    }
                    disableWhen.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("xwfOption".equals(this.getName()))
            {
