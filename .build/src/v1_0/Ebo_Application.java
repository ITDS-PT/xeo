...
public  class Ebo_Application extends boObject implements  Serializable {  
    ...
    public Ebo_Application() {
        super();
        bo_version      = "1.0";
        bo_name         = "Ebo_Application";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("Ebo_Application");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("Ebo_Application".equals(this.getName()))
            {
