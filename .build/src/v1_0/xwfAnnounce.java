...
public  class xwfAnnounce extends netgest.xwf.core.xwfAnnounceImpl implements  Serializable {  
    ...
    public xwfAnnounce() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("xwfAnnounce");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("xwfAnnounce".equals(this.getName()))
            {
