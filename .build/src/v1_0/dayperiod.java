...
public  class dayperiod extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeString description;    
    public netgest.bo.runtime.attributes.boAttributeString workTime;    
    public netgest.bo.runtime.attributes.boAttributeString launchTime;    
    public netgest.bo.runtime.attributes.boAttributeString beginTimePeriod;    
    public netgest.bo.runtime.attributes.boAttributeString endTimePeriod;    
    ...
    public dayperiod() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("dayperiod");
        ...
        atts.add(workTime = new netgest.bo.runtime.attributes.boAttributeString(this,"workTime"));
        
        atts.add(launchTime = new netgest.bo.runtime.attributes.boAttributeString(this,"launchTime"));
        
        atts.add(beginTimePeriod = new netgest.bo.runtime.attributes.boAttributeString(this,"beginTimePeriod"));
        
        atts.add(endTimePeriod = new netgest.bo.runtime.attributes.boAttributeString(this,"endTimePeriod"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( workTime.haveDefaultValue()) 
                {
                	if(workTime.defaultValue() != null)
                	{
                    	workTime._setValue(boConvertUtils.convertToString(workTime.defaultValue(), workTime));
                    }
                    else
                    {
                    	workTime._setValue(null);
                    }
                    workTime.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( launchTime.haveDefaultValue()) 
                {
                	if(launchTime.defaultValue() != null)
                	{
                    	launchTime._setValue(boConvertUtils.convertToString(launchTime.defaultValue(), launchTime));
                    }
                    else
                    {
                    	launchTime._setValue(null);
                    }
                    launchTime.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( beginTimePeriod.haveDefaultValue()) 
                {
                	if(beginTimePeriod.defaultValue() != null)
                	{
                    	beginTimePeriod._setValue(boConvertUtils.convertToString(beginTimePeriod.defaultValue(), beginTimePeriod));
                    }
                    else
                    {
                    	beginTimePeriod._setValue(null);
                    }
                    beginTimePeriod.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( endTimePeriod.haveDefaultValue()) 
                {
                	if(endTimePeriod.defaultValue() != null)
                	{
                    	endTimePeriod._setValue(boConvertUtils.convertToString(endTimePeriod.defaultValue(), endTimePeriod));
                    }
                    else
                    {
                    	endTimePeriod._setValue(null);
                    }
                    endTimePeriod.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("dayperiod".equals(this.getName()))
            {
