...
public  class holiday extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeDate day;    
    public netgest.bo.runtime.attributes.boAttributeString description;    
    public netgest.bo.runtime.attributes.boAttributeString defined;    
    public netgest.bo.runtime.attributes.boAttributeString repeat;    
    ...
    public holiday() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("holiday");
        ...
        atts.add(day = new netgest.bo.runtime.attributes.boAttributeDate(this,"day"));
        
        atts.add(description = new netgest.bo.runtime.attributes.boAttributeString(this,"description"));
        
        atts.add(defined = new netgest.bo.runtime.attributes.boAttributeString(this,"defined"));
        
        atts.add(repeat = new netgest.bo.runtime.attributes.boAttributeString(this,"repeat"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( day.haveDefaultValue()) 
                {
                	if(day.defaultValue() != null)
                	{
                    	day._setValue(boConvertUtils.convertToTimestamp(day.defaultValue(), day));
                    }
                    else
                    {
                    	day._setValue(null);
                    }
                    day.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
                ...
                if( defined.haveDefaultValue()) 
                {
                	if(defined.defaultValue() != null)
                	{
                    	defined._setValue(boConvertUtils.convertToString(defined.defaultValue(), defined));
                    }
                    else
                    {
                    	defined._setValue(null);
                    }
                    defined.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( repeat.haveDefaultValue()) 
                {
                	if(repeat.defaultValue() != null)
                	{
                    	repeat._setValue(boConvertUtils.convertToString(repeat.defaultValue(), repeat));
                    }
                    else
                    {
                    	repeat._setValue(null);
                    }
                    repeat.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("holiday".equals(this.getName()))
            {
...
this.day.setValueFormula(new Hashtable() , getDependences("day"));
this.repeat.setValueFormula(new Hashtable() , getDependences("repeat"));
}
}
}
