...
public  class Ebo_Compartment extends boObject implements  Serializable {  
    ...
    public Ebo_Compartment() {
        super();
        bo_version      = "1.0";
        bo_name         = "Ebo_Compartment";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("Ebo_Compartment");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("Ebo_Compartment".equals(this.getName()))
            {
