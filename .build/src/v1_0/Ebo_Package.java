...
public  class Ebo_Package extends boObject implements  Serializable {  
    ...
    public Ebo_Package() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("Ebo_Package");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("Ebo_Package".equals(this.getName()))
            {
