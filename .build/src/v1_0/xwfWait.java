...
public  class xwfWait extends boObject implements  Serializable {  
    ...
    public netgest.bo.runtime.attributes.boAttributeDate beginTime;    
    public netgest.bo.runtime.attributes.boAttributeDate endTime;    
    public netgest.bo.runtime.attributes.boAttributeNumber maxDuration;    
    public netgest.bo.runtime.attributes.boAttributeObject program;    
    public netgest.bo.runtime.attributes.boAttributeString waitFor;    
    ...
    public netgest.bo.runtime.attributes.boAttributeString done;    
    ...
    public xwfWait() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("xwfWait");
        ...
        atts.add(beginTime = new netgest.bo.runtime.attributes.boAttributeDate(this,"beginTime"));
        
        atts.add(endTime = new netgest.bo.runtime.attributes.boAttributeDate(this,"endTime"));
        
        atts.add(maxDuration = new netgest.bo.runtime.attributes.boAttributeNumber(this,"maxDuration"));
        
        atts.add(program = new netgest.bo.runtime.attributes.boAttributeObject(this,"program"));
        
        atts.add(waitFor = new netgest.bo.runtime.attributes.boAttributeString(this,"waitFor"));
        ...
        atts.add(done = new netgest.bo.runtime.attributes.boAttributeString(this,"done"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( beginTime.haveDefaultValue()) 
                {
                	if(beginTime.defaultValue() != null)
                	{
                    	beginTime._setValue(boConvertUtils.convertToTimestamp(beginTime.defaultValue(), beginTime));
                    }
                    else
                    {
                    	beginTime._setValue(null);
                    }
                    beginTime.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( endTime.haveDefaultValue()) 
                {
                	if(endTime.defaultValue() != null)
                	{
                    	endTime._setValue(boConvertUtils.convertToTimestamp(endTime.defaultValue(), endTime));
                    }
                    else
                    {
                    	endTime._setValue(null);
                    }
                    endTime.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( maxDuration.haveDefaultValue()) 
                {
                	if(maxDuration.defaultValue() != null)
                	{
                    	maxDuration._setValue(boConvertUtils.convertToBigDecimal(maxDuration.defaultValue(), maxDuration));
                    }
                    else
                    {
                    	maxDuration._setValue(null);
                    }
                    maxDuration.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
                ...
                if( waitFor.haveDefaultValue()) 
                {
                	if(waitFor.defaultValue() != null)
                	{
                    	waitFor._setValue(boConvertUtils.convertToString(waitFor.defaultValue(), waitFor));
                    }
                    else
                    {
                    	waitFor._setValue(null);
                    }
                    waitFor.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
                ...
                if( done.haveDefaultValue()) 
                {
                	if(done.defaultValue() != null)
                	{
                    	done._setValue(boConvertUtils.convertToString(done.defaultValue(), done));
                    }
                    else
                    {
                    	done._setValue(null);
                    }
                    done.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("xwfWait".equals(this.getName()))
            {
