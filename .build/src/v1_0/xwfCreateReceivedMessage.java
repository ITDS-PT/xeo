...
public  class xwfCreateReceivedMessage extends xwfActivity implements  Serializable {  
    ...
    public xwfCreateReceivedMessage() {
        super();
        bo_version      = "1.0";
        bo_name         = "xwfCreateReceivedMessage";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("xwfCreateReceivedMessage");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("xwfCreateReceivedMessage".equals(this.getName()))
            {
