...
public  class Ebo_ShortCut extends boObject implements  Serializable {  
    ...
    public netgest.bo.runtime.attributes.boAttributeObject cls;    
    ...
    public Ebo_ShortCut() {
        super();
        bo_version      = "1.0";
        bo_name         = "Ebo_ShortCut";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("Ebo_ShortCut");
        ...
        atts.add(cls = new netgest.bo.runtime.attributes.boAttributeObject(this,"cls"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( cls.haveDefaultValue()) 
                {
                	if(cls.defaultValue() != null)
                	{
                    	cls._setValue(boConvertUtils.convertToBigDecimal(cls.defaultValue(), cls));
                    }
                    else
                    {
                    	cls._setValue(null);
                    }
                    cls.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("Ebo_ShortCut".equals(this.getName()))
            {
