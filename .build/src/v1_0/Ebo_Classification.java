...
public  class Ebo_Classification extends boObject implements  Serializable {  
    ...
    public Ebo_Classification() {
        super();
        bo_version      = "1.0";
        bo_name         = "Ebo_Classification";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("Ebo_Classification");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("Ebo_Classification".equals(this.getName()))
            {
