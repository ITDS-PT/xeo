...
public  class xwfActivityFill extends xwfActivity implements  Serializable {  
    ...
    public xwfActivityFill() {
        super();
        bo_version      = "1.0";
        bo_name         = "xwfActivityFill";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("xwfActivityFill");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("xwfActivityFill".equals(this.getName()))
            {
