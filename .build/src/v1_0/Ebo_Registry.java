...
public  class Ebo_Registry extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeObject clsbo;    
    public netgest.bo.runtime.attributes.boAttributeObject ui;    
    public netgest.bo.runtime.attributes.boAttributeNumber ui_version;    
    public netgest.bo.runtime.attributes.boAttributeString name;    
    public netgest.bo.runtime.attributes.boAttributeString clsid;    
    public netgest.bo.runtime.attributes.boAttributeNumber clsid_major_version;    
    public netgest.bo.runtime.attributes.boAttributeNumber clsid_minor_version;    
    ...
    public Ebo_Registry() {
        super();
        bo_version      = "1.0";
        bo_name         = "Ebo_Registry";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("Ebo_Registry");
        ...
        atts.add(clsbo = new netgest.bo.runtime.attributes.boAttributeObject(this,"clsbo"));
        
        atts.add(ui = new netgest.bo.runtime.attributes.boAttributeObject(this,"ui"));
        
        atts.add(ui_version = new netgest.bo.runtime.attributes.boAttributeNumber(this,"ui_version"));
        
        atts.add(name = new netgest.bo.runtime.attributes.boAttributeString(this,"name"));
        
        atts.add(clsid = new netgest.bo.runtime.attributes.boAttributeString(this,"clsid"));
        
        atts.add(clsid_major_version = new netgest.bo.runtime.attributes.boAttributeNumber(this,"clsid_major_version"));
        
        atts.add(clsid_minor_version = new netgest.bo.runtime.attributes.boAttributeNumber(this,"clsid_minor_version"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( clsbo.haveDefaultValue()) 
                {
                	if(clsbo.defaultValue() != null)
                	{
                    	clsbo._setValue(boConvertUtils.convertToBigDecimal(clsbo.defaultValue(), clsbo));
                    }
                    else
                    {
                    	clsbo._setValue(null);
                    }
                    clsbo.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( ui.haveDefaultValue()) 
                {
                	if(ui.defaultValue() != null)
                	{
                    	ui._setValue(boConvertUtils.convertToBigDecimal(ui.defaultValue(), ui));
                    }
                    else
                    {
                    	ui._setValue(null);
                    }
                    ui.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( ui_version.haveDefaultValue()) 
                {
                	if(ui_version.defaultValue() != null)
                	{
                    	ui_version._setValue(boConvertUtils.convertToBigDecimal(ui_version.defaultValue(), ui_version));
                    }
                    else
                    {
                    	ui_version._setValue(null);
                    }
                    ui_version.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
                ...
                if( clsid.haveDefaultValue()) 
                {
                	if(clsid.defaultValue() != null)
                	{
                    	clsid._setValue(boConvertUtils.convertToString(clsid.defaultValue(), clsid));
                    }
                    else
                    {
                    	clsid._setValue(null);
                    }
                    clsid.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( clsid_major_version.haveDefaultValue()) 
                {
                	if(clsid_major_version.defaultValue() != null)
                	{
                    	clsid_major_version._setValue(boConvertUtils.convertToBigDecimal(clsid_major_version.defaultValue(), clsid_major_version));
                    }
                    else
                    {
                    	clsid_major_version._setValue(null);
                    }
                    clsid_major_version.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( clsid_minor_version.haveDefaultValue()) 
                {
                	if(clsid_minor_version.defaultValue() != null)
                	{
                    	clsid_minor_version._setValue(boConvertUtils.convertToBigDecimal(clsid_minor_version.defaultValue(), clsid_minor_version));
                    }
                    else
                    {
                    	clsid_minor_version._setValue(null);
                    }
                    clsid_minor_version.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("Ebo_Registry".equals(this.getName()))
            {
    ...
    public final class Handlerstate extends boObjectStateHandler {
        ...
        public final String STATE_production="0";
        
        public final String STATE_cancel="-1";
