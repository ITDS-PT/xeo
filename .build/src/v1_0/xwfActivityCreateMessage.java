...
public  class xwfActivityCreateMessage extends xwfActivity implements  Serializable {  
    ...
    public xwfActivityCreateMessage() {
        super();
        bo_version      = "1.0";
        bo_name         = "xwfActivityCreateMessage";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("xwfActivityCreateMessage");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("xwfActivityCreateMessage".equals(this.getName()))
            {
