...
public  class messageReceipt extends messageSystem implements  Serializable {  
    ...
    public messageReceipt() {
        super();
        bo_version      = "1.0";
        bo_name         = "messageReceipt";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("messageReceipt");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("messageReceipt".equals(this.getName()))
            {
