...
public  class Ebo_AnnounceDetails extends boObject implements  Serializable {  
    ...
    public Ebo_AnnounceDetails() {
        super();
        bo_version      = "1.0";
        bo_name         = "Ebo_AnnounceDetails";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("Ebo_AnnounceDetails");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("Ebo_AnnounceDetails".equals(this.getName()))
            {
