...
public  class messageDelivered extends messageSystem implements  Serializable {  
    ...
    public messageDelivered() {
        super();
        bo_version      = "1.0";
        bo_name         = "messageDelivered";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("messageDelivered");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("messageDelivered".equals(this.getName()))
            {
