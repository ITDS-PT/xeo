...
public  class Ebo_Attribute extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeObject clsReg;    
    ...
    public Ebo_Attribute() {
        super();
        bo_version      = "1.0";
        bo_name         = "Ebo_Attribute";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("Ebo_Attribute");
        ...
        atts.add(clsReg = new netgest.bo.runtime.attributes.boAttributeObject(this,"clsReg"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( clsReg.haveDefaultValue()) 
                {
                	if(clsReg.defaultValue() != null)
                	{
                    	clsReg._setValue(boConvertUtils.convertToBigDecimal(clsReg.defaultValue(), clsReg));
                    }
                    else
                    {
                    	clsReg._setValue(null);
                    }
                    clsReg.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("Ebo_Attribute".equals(this.getName()))
            {
