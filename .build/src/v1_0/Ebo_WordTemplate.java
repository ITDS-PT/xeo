...
public  class Ebo_WordTemplate extends Ebo_DocumentTemplate implements  Serializable {  
    ...
    public Ebo_WordTemplate() {
        super();
        bo_version      = "1.0";
        bo_name         = "Ebo_WordTemplate";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("Ebo_WordTemplate");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("Ebo_WordTemplate".equals(this.getName()))
            {
