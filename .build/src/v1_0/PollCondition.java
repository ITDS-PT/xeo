...
public  class PollCondition extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeString instantEval;    
    public netgest.bo.runtime.attributes.boAttributeString code;    
    public netgest.bo.runtime.attributes.boAttributeString field;    
    public netgest.bo.runtime.attributes.boAttributeObject option;    
    public netgest.bo.runtime.attributes.boAttributeObject voter;    
    public netgest.bo.runtime.attributes.boAttributeString criteria;    
    public netgest.bo.runtime.attributes.boAttributeString expression;    
    ...
    public PollCondition() {
        super();
        bo_version      = "1.0";
        bo_name         = "PollCondition";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("PollCondition");
        ...
        atts.add(instantEval = new netgest.bo.runtime.attributes.boAttributeString(this,"instantEval"));
        
        atts.add(code = new netgest.bo.runtime.attributes.boAttributeString(this,"code"));
        
        atts.add(field = new netgest.bo.runtime.attributes.boAttributeString(this,"field"));
        
        atts.add(option = new netgest.bo.runtime.attributes.boAttributeObject(this,"option"));
        
        atts.add(voter = new netgest.bo.runtime.attributes.boAttributeObject(this,"voter"));
        
        atts.add(criteria = new netgest.bo.runtime.attributes.boAttributeString(this,"criteria"));
        
        atts.add(expression = new netgest.bo.runtime.attributes.boAttributeString(this,"expression"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( instantEval.haveDefaultValue()) 
                {
                	if(instantEval.defaultValue() != null)
                	{
                    	instantEval._setValue(boConvertUtils.convertToString(instantEval.defaultValue(), instantEval));
                    }
                    else
                    {
                    	instantEval._setValue(null);
                    }
                    instantEval.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
                ...
                if( field.haveDefaultValue()) 
                {
                	...
                	{
                    	field._setValue(boConvertUtils.convertToString(field.defaultValue(), field));
                    }
                    else
                    {
                    	field._setValue(null);
                    }
                    field.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( option.haveDefaultValue()) 
                {
                	if(option.defaultValue() != null)
                	{
                    	option._setValue(boConvertUtils.convertToBigDecimal(option.defaultValue(), option));
                    }
                    else
                    {
                    	option._setValue(null);
                    }
                    option.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( voter.haveDefaultValue()) 
                {
                	if(voter.defaultValue() != null)
                	{
                    	voter._setValue(boConvertUtils.convertToBigDecimal(voter.defaultValue(), voter));
                    }
                    else
                    {
                    	voter._setValue(null);
                    }
                    voter.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( criteria.haveDefaultValue()) 
                {
                	if(criteria.defaultValue() != null)
                	{
                    	criteria._setValue(boConvertUtils.convertToString(criteria.defaultValue(), criteria));
                    }
                    else
                    {
                    	criteria._setValue(null);
                    }
                    criteria.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( expression.haveDefaultValue()) 
                {
                	if(expression.defaultValue() != null)
                	{
                    	expression._setValue(boConvertUtils.convertToString(expression.defaultValue(), expression));
                    }
                    else
                    {
                    	expression._setValue(null);
                    }
                    expression.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("PollCondition".equals(this.getName()))
            {
