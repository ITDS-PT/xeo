...
public  class Organization extends boObject implements  Serializable {  
    ...
    public Organization() {
        super();
        bo_version      = "1.0";
        bo_name         = "Organization";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("Organization");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("Organization".equals(this.getName()))
            {
