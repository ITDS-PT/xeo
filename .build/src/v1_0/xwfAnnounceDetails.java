...
public  class xwfAnnounceDetails extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeString message;    
    public netgest.bo.runtime.attributes.boAttributeObject objMessage;    
    ...
    public netgest.bo.runtime.attributes.boAttributeObject referenceObject;    
    ...
    public xwfAnnounceDetails() {
        super();
        bo_version      = "1.0";
        bo_name         = "xwfAnnounceDetails";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("xwfAnnounceDetails");
        ...
        atts.add(message = new netgest.bo.runtime.attributes.boAttributeString(this,"message"));
        
        atts.add(objMessage = new netgest.bo.runtime.attributes.boAttributeObject(this,"objMessage"));
        ...
        atts.add(referenceObject = new netgest.bo.runtime.attributes.boAttributeObject(this,"referenceObject"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( message.haveDefaultValue()) 
                {
                	...
                	{
                    	message._setValue(boConvertUtils.convertToString(message.defaultValue(), message));
                    }
                    else
                    {
                ...
                if( objMessage.haveDefaultValue()) 
                {
                	if(objMessage.defaultValue() != null)
                	{
                    	objMessage._setValue(boConvertUtils.convertToBigDecimal(objMessage.defaultValue(), objMessage));
                    }
                    else
                    {
                    	objMessage._setValue(null);
                    }
                    objMessage.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
                ...
                if( referenceObject.haveDefaultValue()) 
                {
                	if(referenceObject.defaultValue() != null)
                	{
                    	referenceObject._setValue(boConvertUtils.convertToBigDecimal(referenceObject.defaultValue(), referenceObject));
                    }
                    else
                    {
                    	referenceObject._setValue(null);
                    }
                    referenceObject.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("xwfAnnounceDetails".equals(this.getName()))
            {
