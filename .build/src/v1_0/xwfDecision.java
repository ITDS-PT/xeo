...
public  class xwfDecision extends boObject implements  Serializable {  
    ...
    public xwfDecision() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("xwfDecision");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("xwfDecision".equals(this.getName()))
            {
...
	public String transfToString() throws boRuntimeException {
	return "O utilizador '" + this.getAttribute("performer").getObject().getCARDIDwNoIMG() + "' respondeu '" +  this.getAttribute("answer").getValueString() + "' justicando que: " +  this.getAttribute("justification").getValueString() ;
