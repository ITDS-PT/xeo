...
public  class forwarding extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeString forwarding;    
    ...
    public forwarding() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("forwarding");
        ...
        atts.add(forwarding = new netgest.bo.runtime.attributes.boAttributeString(this,"forwarding"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( forwarding.haveDefaultValue()) 
                {
                	...
                	{
                    	forwarding._setValue(boConvertUtils.convertToString(forwarding.defaultValue(), forwarding));
                    }
                    else
                    {
            ...
            if("forwarding".equals(this.getName()))
            {
