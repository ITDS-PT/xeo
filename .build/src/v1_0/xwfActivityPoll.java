...
public  class xwfActivityPoll extends xwfActivity implements  Serializable {  
    ...
    public xwfActivityPoll() {
        super();
        bo_version      = "1.0";
        bo_name         = "xwfActivityPoll";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("xwfActivityPoll");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("xwfActivityPoll".equals(this.getName()))
            {
