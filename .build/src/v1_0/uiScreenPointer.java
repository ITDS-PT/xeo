...
public  class uiScreenPointer extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeString name;    
    public netgest.bo.runtime.attributes.boAttributeString img;    
    ...
    public netgest.bo.runtime.attributes.boAttributeObject uiObject;    
    public netgest.bo.runtime.attributes.boAttributeString formName;    
    public netgest.bo.runtime.attributes.boAttributeString pointerTo;    
    public netgest.bo.runtime.attributes.boAttributeString xeoQL;    
    ...
    public uiScreenPointer() {
        super();
        bo_version      = "1.0";
        bo_name         = "uiScreenPointer";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("uiScreenPointer");
        ...
        atts.add(img = new netgest.bo.runtime.attributes.boAttributeString(this,"img"));
        ...
        atts.add(uiObject = new netgest.bo.runtime.attributes.boAttributeObject(this,"uiObject"));
        
        atts.add(formName = new netgest.bo.runtime.attributes.boAttributeString(this,"formName"));
        
        atts.add(pointerTo = new netgest.bo.runtime.attributes.boAttributeString(this,"pointerTo"));
        
        atts.add(xeoQL = new netgest.bo.runtime.attributes.boAttributeString(this,"xeoQL"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( img.haveDefaultValue()) 
                {
                	if(img.defaultValue() != null)
                	{
                    	img._setValue(boConvertUtils.convertToString(img.defaultValue(), img));
                    }
                    else
                    {
                    	img._setValue(null);
                    }
                    img.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
                ...
                if( uiObject.haveDefaultValue()) 
                {
                	if(uiObject.defaultValue() != null)
                	{
                    	uiObject._setValue(boConvertUtils.convertToBigDecimal(uiObject.defaultValue(), uiObject));
                    }
                    else
                    {
                    	uiObject._setValue(null);
                    }
                    uiObject.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( formName.haveDefaultValue()) 
                {
                	if(formName.defaultValue() != null)
                	{
                    	formName._setValue(boConvertUtils.convertToString(formName.defaultValue(), formName));
                    }
                    else
                    {
                    	formName._setValue(null);
                    }
                    formName.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( pointerTo.haveDefaultValue()) 
                {
                	if(pointerTo.defaultValue() != null)
                	{
                    	pointerTo._setValue(boConvertUtils.convertToString(pointerTo.defaultValue(), pointerTo));
                    }
                    else
                    {
                    	pointerTo._setValue(null);
                    }
                    pointerTo.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( xeoQL.haveDefaultValue()) 
                {
                	if(xeoQL.defaultValue() != null)
                	{
                    	xeoQL._setValue(boConvertUtils.convertToString(xeoQL.defaultValue(), xeoQL));
                    }
                    else
                    {
                    	xeoQL._setValue(null);
                    }
                    xeoQL.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("uiScreenPointer".equals(this.getName()))
            {
