...
public  class messageInternal extends messageLetter implements  Serializable {  
    ...
    public messageInternal() {
        super();
        bo_version      = "1.0";
        bo_name         = "messageInternal";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("messageInternal");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("messageInternal".equals(this.getName()))
            {
