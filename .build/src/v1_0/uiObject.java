...
public  class uiObject extends boObject implements  Serializable {  
    ...
    public netgest.bo.runtime.attributes.boAttributeObject profile;    
    ...
    public uiObject() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("uiObject");
        ...
        atts.add(profile = new netgest.bo.runtime.attributes.boAttributeObject(this,"profile"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( profile.haveDefaultValue()) 
                {
                	...
                	{
                    	profile._setValue(boConvertUtils.convertToBigDecimal(profile.defaultValue(), profile));
                    }
                    else
                    {
            ...
            if("uiObject".equals(this.getName()))
            {
