...
public  class messageSMS extends message implements  Serializable {  
    ...
    public netgest.bo.runtime.attributes.boAttributeString textSMS;    
    ...
    public messageSMS() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("messageSMS");
        ...
        atts.add(textSMS = new netgest.bo.runtime.attributes.boAttributeString(this,"textSMS"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( textSMS.haveDefaultValue()) 
                {
                	if(textSMS.defaultValue() != null)
                	{
                    	textSMS._setValue(boConvertUtils.convertToString(textSMS.defaultValue(), textSMS));
                    }
                    else
                    {
                    	textSMS._setValue(null);
                    }
                    textSMS.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
    
            if("messageSMS".equals(this.getName()))
            {
