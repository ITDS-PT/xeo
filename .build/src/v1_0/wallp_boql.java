...
public  class wallp_boql extends boObject implements  Serializable {  
    ...
    public wallp_boql() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("wallp_boql");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("wallp_boql".equals(this.getName()))
            {
