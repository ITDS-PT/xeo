...
public  class wall_knowledge extends boObject implements  Serializable {  
    ...
    public wall_knowledge() {
        super();
        bo_version      = "1.0";
        bo_name         = "wall_knowledge";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("wall_knowledge");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("wall_knowledge".equals(this.getName()))
            {
