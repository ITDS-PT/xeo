...
public  class messageLetter extends message implements  Serializable {  
    ...
    public messageLetter() {
        super();
        bo_version      = "1.0";
        bo_name         = "messageLetter";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("messageLetter");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("messageLetter".equals(this.getName()))
            {
...
return new String[] {"to", "toRef", "preferedMedia", "faxFormat", "from", "cc", "bcc", "createdReceiveMsg", "letterFormat", "statusMessage"} ;
}
