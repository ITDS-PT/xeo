...
public  class xwfActivitySend extends xwfActivity implements  Serializable {  
    ...
    public xwfActivitySend() {
        super();
        bo_version      = "1.0";
        bo_name         = "xwfActivitySend";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("xwfActivitySend");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("xwfActivitySend".equals(this.getName()))
            {
