...
public  class Ebo_DAOparameter extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeNumber extAttrParentBoui;    
    public netgest.bo.runtime.attributes.boAttributeString extAttrAliasParent;    
    public netgest.bo.runtime.attributes.boAttributeString extAttrAliasChild;    
    public netgest.bo.runtime.attributes.boAttributeString inout;    
    ...
    public Ebo_DAOparameter() {
        super();
        bo_version      = "1.0";
        bo_name         = "Ebo_DAOparameter";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("Ebo_DAOparameter");
        ...
        atts.add(extAttrParentBoui = new netgest.bo.runtime.attributes.boAttributeNumber(this,"extAttrParentBoui"));
        
        atts.add(extAttrAliasParent = new netgest.bo.runtime.attributes.boAttributeString(this,"extAttrAliasParent"));
        
        atts.add(extAttrAliasChild = new netgest.bo.runtime.attributes.boAttributeString(this,"extAttrAliasChild"));
        
        atts.add(inout = new netgest.bo.runtime.attributes.boAttributeString(this,"inout"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( extAttrParentBoui.haveDefaultValue()) 
                {
                	if(extAttrParentBoui.defaultValue() != null)
                	{
                    	extAttrParentBoui._setValue(boConvertUtils.convertToBigDecimal(extAttrParentBoui.defaultValue(), extAttrParentBoui));
                    }
                    else
                    {
                    	extAttrParentBoui._setValue(null);
                    }
                    extAttrParentBoui.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( extAttrAliasParent.haveDefaultValue()) 
                {
                	if(extAttrAliasParent.defaultValue() != null)
                	{
                    	extAttrAliasParent._setValue(boConvertUtils.convertToString(extAttrAliasParent.defaultValue(), extAttrAliasParent));
                    }
                    else
                    {
                    	extAttrAliasParent._setValue(null);
                    }
                    extAttrAliasParent.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( extAttrAliasChild.haveDefaultValue()) 
                {
                	if(extAttrAliasChild.defaultValue() != null)
                	{
                    	extAttrAliasChild._setValue(boConvertUtils.convertToString(extAttrAliasChild.defaultValue(), extAttrAliasChild));
                    }
                    else
                    {
                    	extAttrAliasChild._setValue(null);
                    }
                    extAttrAliasChild.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( inout.haveDefaultValue()) 
                {
                	if(inout.defaultValue() != null)
                	{
                    	inout._setValue(boConvertUtils.convertToString(inout.defaultValue(), inout));
                    }
                    else
                    {
                    	inout._setValue(null);
                    }
                    inout.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("Ebo_DAOparameter".equals(this.getName()))
            {
...
	public StringBuffer getCardIDByExtendAttributeAlias() throws boRuntimeException {
...
	public StringBuffer getAliasChildLov() throws boRuntimeException {
