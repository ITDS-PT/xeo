...
public  class Ebo_Announce extends netgest.bo.impl.Ebo_AnnounceImpl implements  Serializable {  
    ...
    public Ebo_Announce() {
        super();
        bo_version      = "1.0";
        bo_name         = "Ebo_Announce";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("Ebo_Announce");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("Ebo_Announce".equals(this.getName()))
            {
