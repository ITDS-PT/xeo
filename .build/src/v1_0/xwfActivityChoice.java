...
public  class xwfActivityChoice extends xwfActivity implements  Serializable {  
    ...
    public xwfActivityChoice() {
        super();
        bo_version      = "1.0";
        bo_name         = "xwfActivityChoice";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("xwfActivityChoice");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("xwfActivityChoice".equals(this.getName()))
            {
