...
public  class mailError extends boObject implements  Serializable {  
    ...
    public netgest.bo.runtime.attributes.boAttributeString error;    
    ...
    public mailError() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("mailError");
        ...
        atts.add(error = new netgest.bo.runtime.attributes.boAttributeString(this,"error"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( error.haveDefaultValue()) 
                {
                	if(error.defaultValue() != null)
                	{
                    	error._setValue(boConvertUtils.convertToString(error.defaultValue(), error));
                    }
                    else
                    {
                    	error._setValue(null);
                    }
                    error.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("mailError".equals(this.getName()))
            {
