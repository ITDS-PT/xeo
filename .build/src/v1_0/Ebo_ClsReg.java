...
public  class Ebo_ClsReg extends boObject implements  Serializable {  

   
   
   
    public netgest.bo.runtime.attributes.boAttributeObject xeopackage;    
    public netgest.bo.runtime.attributes.boAttributeString name;    
    public netgest.bo.runtime.attributes.boAttributeString phisicaltable;    
    ...
    public netgest.bo.runtime.attributes.boAttributeString ClsChild;    
    public netgest.bo.runtime.attributes.boAttributeString deployed;    
    public netgest.bo.runtime.attributes.boAttributeObject defaulttemplate;    
    public netgest.bo.runtime.attributes.boAttributeString xmlsource;    
    ...
    public Ebo_ClsReg() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("Ebo_ClsReg");
        ...
        atts.add(new boBridgeMasterAttribute(this,this.getBoDefinition().getAttributeRef("security")));  
        atts.add(new boBridgeMasterAttribute(this,this.getBoDefinition().getAttributeRef("attributes")));  
        atts.add(new boBridgeMasterAttribute(this,this.getBoDefinition().getAttributeRef("methods"))); 

       
        
       
        atts.add(xeopackage = new netgest.bo.runtime.attributes.boAttributeObject(this,"xeopackage"));
        
        atts.add(name = new netgest.bo.runtime.attributes.boAttributeString(this,"name"));
        
        atts.add(phisicaltable = new netgest.bo.runtime.attributes.boAttributeString(this,"phisicaltable"));
        ...
        atts.add(ClsChild = new netgest.bo.runtime.attributes.boAttributeString(this,"ClsChild"));
        
        atts.add(deployed = new netgest.bo.runtime.attributes.boAttributeString(this,"deployed"));
        
        atts.add(defaulttemplate = new netgest.bo.runtime.attributes.boAttributeObject(this,"defaulttemplate"));
        
        atts.add(xmlsource = new netgest.bo.runtime.attributes.boAttributeString(this,"xmlsource"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( xeopackage.haveDefaultValue()) 
                {
                	if(xeopackage.defaultValue() != null)
                	{
                    	xeopackage._setValue(boConvertUtils.convertToBigDecimal(xeopackage.defaultValue(), xeopackage));
                    }
                    else
                    {
                    	xeopackage._setValue(null);
                    }
                    xeopackage.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
                ...
                if( phisicaltable.haveDefaultValue()) 
                {
                	if(phisicaltable.defaultValue() != null)
                	{
                    	phisicaltable._setValue(boConvertUtils.convertToString(phisicaltable.defaultValue(), phisicaltable));
                    }
                    else
                    {
                    	phisicaltable._setValue(null);
                    }
                    phisicaltable.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
                ...
                if( ClsChild.haveDefaultValue()) 
                {
                	if(ClsChild.defaultValue() != null)
                	{
                    	ClsChild._setValue(boConvertUtils.convertToString(ClsChild.defaultValue(), ClsChild));
                    }
                    else
                    {
                    	ClsChild._setValue(null);
                    }
                    ClsChild.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( deployed.haveDefaultValue()) 
                {
                	if(deployed.defaultValue() != null)
                	{
                    	deployed._setValue(boConvertUtils.convertToString(deployed.defaultValue(), deployed));
                    }
                    else
                    {
                    	deployed._setValue(null);
                    }
                    deployed.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( defaulttemplate.haveDefaultValue()) 
                {
                	if(defaulttemplate.defaultValue() != null)
                	{
                    	defaulttemplate._setValue(boConvertUtils.convertToBigDecimal(defaulttemplate.defaultValue(), defaulttemplate));
                    }
                    else
                    {
                    	defaulttemplate._setValue(null);
                    }
                    defaulttemplate.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( xmlsource.haveDefaultValue()) 
                {
                	if(xmlsource.defaultValue() != null)
                	{
                    	xmlsource._setValue(boConvertUtils.convertToString(xmlsource.defaultValue(), xmlsource));
                    }
                    else
                    {
                    	xmlsource._setValue(null);
                    }
                    xmlsource.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("Ebo_ClsReg".equals(this.getName()))
            {
    ...
    public bridgeHandler security()
    {
        return getBridge("security");        
    }
    
    public bridgeHandler attributes()
    {
        return getBridge("attributes");        
    }
    
    public bridgeHandler methods()
    {
        return getBridge("methods");        
    }
    ...
    public bridgeHandler getBridge( String bridgeName ) 
    {
        ...
        if( ret == null )
        {
        	...
        	if( bridgeName.equals("security") && (ret=brig.get("security"))==null )
        	{
            	brig.add( ret=new BridgeHandlersecurity(new DataResultSet( getDataRow().getRecordChild( getEboContext() ,"security") ) , this ) );        
        	}
        	if( bridgeName.equals("attributes") && (ret=brig.get("attributes"))==null )
        	{
            	brig.add( ret=new BridgeHandlerattributes(new DataResultSet( getDataRow().getRecordChild( getEboContext() ,"attributes") ) , this ) );        
        	}
        	if( bridgeName.equals("methods") && (ret=brig.get("methods"))==null )
        	{
            	brig.add( ret=new BridgeHandlermethods(new DataResultSet( getDataRow().getRecordChild( getEboContext() ,"methods") ) , this ) );        
        	}
        	if( ret == null )
        	{
    ...
    public final class BridgeHandlersecurity extends bridgeHandler {
        ...
        public BridgeHandlersecurity(DataResultSet data,boObject parent) {
            super("security",
                  data,
                  parent.getBoDefinition().getAttributeRef("security").getBridge().getChildFieldName(),
                  parent
                 );

            p_fatherfield = parent.getBoDefinition().getAttributeRef("security").getBridge().getFatherFieldName();
            p_childfield  = parent.getBoDefinition().getAttributeRef("security").getBridge().getChildFieldName();
...
//			  if( newval != null ) allow=allow && att.onBeforeAdd(new boEvent(att, att.EVENT_BEFORE_ADD,newval));
			  ...
			  if( att.fireBeforeChangeEvent( att, null, newval) ) 
			  {
                  ...
                  if(getParent().onChangeSubmit("security"))
                  {
                      getParent().calculateFormula("security");
                  }
...
//					att.onAfterChange(new boEvent(att,att.EVENT_AFTER_CHANGE,chgval,null));
		...
		{
			return new BridgeHanldersecurityRow( this, row );
		}

		public final class BridgeHanldersecurityRow extends boBridgeRow
		{
			public BridgeHanldersecurityRow( bridgeHandler bridge, netgest.bo.data.DataRow row )
			{
				super( bridge , row );
				addLine();
			}
			...
			public void addLine() 
			{
				...
				if(this.getAttribute("security")==null)
					xatt.add( new Handlersecurity( getParent(), this ) );
...
return null;
        ...
        public final class Handlersecurity extends BridgeObjAttributeHandler {
            public Handlersecurity( boObject parent , boBridgeRow bridgerow ) {
                super( parent , bridgerow , bridgerow.getBridge().getDefAttribute().getName().equals("security")?parent.getBoDefinition().getAttributeRef("security"):bridgerow.getBridge().getDefAttribute().getBridge().getAttributeRef("security") );
            }
            public void setValueString(String value) {
                try {
                    ...
                    if(getParent().onChangeSubmit("security"))
                    {
                        ...
                        getParent().setCalculated(table, "security");
                        getParent().calculateFormula(table, "security");
                    }
                } catch (Exception e) {
            ...
            public String getValueString() throws boRuntimeException {
                try {
                    ...
                    String[] args = {getParent().getName(),"security"};
            ...
            public void setValueFormula(Hashtable table, String[]dependence) throws boRuntimeException
            {
                ...
                {                       
                    if(getParent().isWaiting(table, "security"))
                    {
                       getParent().setCalculated(table, "security");
                       this.setValue(boConvertUtils.convertToBigDecimal(formula(), this), false );
                    }
                    else if(!getParent().isCalculated(table, "security"))
                    {
                        getParent().setCalculated(table, "security");
                ...
                else if(getParent().dependsFromWaiting(table, dependence))
                {
                    ...
                    {
                        getParent().clear(table, "security"); 
                        this.setValue(boConvertUtils.convertToBigDecimal(formula(), this), false );
                    }
                }
                else
                {   
                    ...
                    if(getParent().onChangeSubmit("security"))
                    {                 
                        getParent().setWaiting(table, "security");
                        getParent().calculateFormula(new Hashtable(table), "security");
                        //getParent().setCalculated(table, "security");
                    }                    
                }
            }
            ...
            public void setValue(BigDecimal newval, boolean recalc) throws boRuntimeException 
            {
                ...
                if( recalc && getParent().onChangeSubmit("security"))
                {
                    Hashtable table = new Hashtable();
                    getParent().setCalculated(table, "security");
                    getParent().calculateFormula(table, "security");
				...
				{
					getParent().getParentBridgeRow().getBridge().lineChanged("security");
				}
            }
...
return null;
    ...
    public final class BridgeHandlerattributes extends bridgeHandler {
        private DataResultSet p_node;
        private String        p_fatherfield;
        private String        p_childfield;
        private boObject      p_parent;
        ...
        public BridgeHandlerattributes(DataResultSet data,boObject parent) {
            super("attributes",
                  data,
                  parent.getBoDefinition().getAttributeRef("attributes").getBridge().getChildFieldName(),
                  parent
                 );

            p_fatherfield = parent.getBoDefinition().getAttributeRef("attributes").getBridge().getFatherFieldName();
            p_childfield  = parent.getBoDefinition().getAttributeRef("attributes").getBridge().getChildFieldName();
...
//			  if( newval != null ) allow=allow && att.onBeforeAdd(new boEvent(att, att.EVENT_BEFORE_ADD,newval));
			  ...
			  if( att.fireBeforeChangeEvent( att, null, newval) ) 
			  {
                  ...
                  if(getParent().onChangeSubmit("attributes"))
                  {
                      getParent().calculateFormula("attributes");
                  }
                  att.fireAfterChangeEvent( att, null, newval );
//				  if( newval != null ) att.onAfterAdd(new boEvent( att ,att.EVENT_AFTER_ADD,newval));
//				  att.onAfterChange(new boEvent( att ,att.EVENT_AFTER_CHANGE, null ,newval));
...
//					att.onAfterChange(new boEvent(att,att.EVENT_AFTER_CHANGE,chgval,null));
		...
		public boBridgeRow createRow( netgest.bo.data.DataRow row )
		{
			return new BridgeHanlderattributesRow( this, row );
		}

		public final class BridgeHanlderattributesRow extends boBridgeRow
		{
			public BridgeHanlderattributesRow( bridgeHandler bridge, netgest.bo.data.DataRow row )
			{
				super( bridge , row );
				addLine();
			}
			...
			public void addLine() 
			{
				...
				if(this.getAttribute("attributes")==null)
					xatt.add( new Handlerattributes( getParent(), this ) );
...
return null;
        ...
        public final class Handlerattributes extends BridgeObjAttributeHandler {
            public Handlerattributes( boObject parent , boBridgeRow bridgerow ) {
                super( parent , bridgerow , bridgerow.getBridge().getDefAttribute().getName().equals("attributes")?parent.getBoDefinition().getAttributeRef("attributes"):bridgerow.getBridge().getDefAttribute().getBridge().getAttributeRef("attributes") );
            }
            public void setValueString(String value) {
                try {
                    this.setValue(boConvertUtils.convertToBigDecimal(value,this));
                    ...
                    {
                        Hashtable table = new Hashtable();                    
                        getParent().setCalculated(table, "attributes");
                        getParent().calculateFormula(table, "attributes");
                    }
                } catch (Exception e) {
                    super.setInvalid(e.getMessage(),value);
                }
            ...
            public String getValueString() throws boRuntimeException {
                try {
                    ...
                    String[] args = {getParent().getName(),"attributes"};
                    throw new boRuntimeException(this.getClass().getName()+".load(EboContext,long)","BO-3003",e,args);
                }
            }
            ...
            public void setValueFormula(Hashtable table, String[]dependence) throws boRuntimeException
            {
                if(getParent().alreadyCalculated(table, dependence)) 
                {                       
                    if(getParent().isWaiting(table, "attributes"))
                    {
                       getParent().setCalculated(table, "attributes");
                       this.setValue(boConvertUtils.convertToBigDecimal(formula(), this), false );
                    }
                    else if(!getParent().isCalculated(table, "attributes"))
                    {
                        getParent().setCalculated(table, "attributes");
                        this.setValue(boConvertUtils.convertToBigDecimal(formula(), this), table );
                    }
                ...
                else if(getParent().dependsFromWaiting(table, dependence))
                {
                    ...
                    {
                        getParent().clear(table, "attributes"); 
                        this.setValue(boConvertUtils.convertToBigDecimal(formula(), this), false );
                    }
                }
                else
                {   
                    ...
                    if(getParent().onChangeSubmit("attributes"))
                    {                 
                        getParent().setWaiting(table, "attributes");
                        getParent().calculateFormula(new Hashtable(table), "attributes");
                        //getParent().setCalculated(table, "attributes");
                    }                    
                }
            }
            ...
            public void setValue(BigDecimal newval, boolean recalc) throws boRuntimeException 
            {
                ...
                if( recalc && getParent().onChangeSubmit("attributes"))
                {
                    Hashtable table = new Hashtable();
                    getParent().setCalculated(table, "attributes");
                    getParent().calculateFormula(table, "attributes");
				...
				if ( getParent().p_parentBridgeRow != null )
				{
					getParent().getParentBridgeRow().getBridge().lineChanged("attributes");
				}
            }
...
return null;
    ...
    public final class BridgeHandlermethods extends bridgeHandler {
        private DataResultSet p_node;
        private String        p_fatherfield;
        private String        p_childfield;
        private boObject      p_parent;
        ...
        public BridgeHandlermethods(DataResultSet data,boObject parent) {
            super("methods",
                  data,
                  parent.getBoDefinition().getAttributeRef("methods").getBridge().getChildFieldName(),
                  parent
                 );

            p_fatherfield = parent.getBoDefinition().getAttributeRef("methods").getBridge().getFatherFieldName();
            p_childfield  = parent.getBoDefinition().getAttributeRef("methods").getBridge().getChildFieldName();
...
//			  if( newval != null ) allow=allow && att.onBeforeAdd(new boEvent(att, att.EVENT_BEFORE_ADD,newval));
			  ...
			  if( att.fireBeforeChangeEvent( att, null, newval) ) 
			  {
                  ...
                  if(getParent().onChangeSubmit("methods"))
                  {
                      getParent().calculateFormula("methods");
                  }
                  att.fireAfterChangeEvent( att, null, newval );
//				  if( newval != null ) att.onAfterAdd(new boEvent( att ,att.EVENT_AFTER_ADD,newval));
//				  att.onAfterChange(new boEvent( att ,att.EVENT_AFTER_CHANGE, null ,newval));
...
//					att.onAfterChange(new boEvent(att,att.EVENT_AFTER_CHANGE,chgval,null));
		...
		public boBridgeRow createRow( netgest.bo.data.DataRow row )
		{
			return new BridgeHanldermethodsRow( this, row );
		}

		public final class BridgeHanldermethodsRow extends boBridgeRow
		{
			public BridgeHanldermethodsRow( bridgeHandler bridge, netgest.bo.data.DataRow row )
			{
				super( bridge , row );
				addLine();
			}
			...
			public void addLine() 
			{
				...
				if(this.getAttribute("methods")==null)
					xatt.add( new Handlermethods( getParent(), this ) );
...
return null;
        ...
        public final class Handlermethods extends BridgeObjAttributeHandler {
            public Handlermethods( boObject parent , boBridgeRow bridgerow ) {
                super( parent , bridgerow , bridgerow.getBridge().getDefAttribute().getName().equals("methods")?parent.getBoDefinition().getAttributeRef("methods"):bridgerow.getBridge().getDefAttribute().getBridge().getAttributeRef("methods") );
            }
            public void setValueString(String value) {
                try {
                    this.setValue(boConvertUtils.convertToBigDecimal(value,this));
                    ...
                    {
                        Hashtable table = new Hashtable();                    
                        getParent().setCalculated(table, "methods");
                        getParent().calculateFormula(table, "methods");
                    }
                } catch (Exception e) {
                    super.setInvalid(e.getMessage(),value);
                }
            ...
            public String getValueString() throws boRuntimeException {
                try {
                    ...
                    String[] args = {getParent().getName(),"methods"};
                    throw new boRuntimeException(this.getClass().getName()+".load(EboContext,long)","BO-3003",e,args);
                }
            }
            ...
            public void setValueFormula(Hashtable table, String[]dependence) throws boRuntimeException
            {
                if(getParent().alreadyCalculated(table, dependence)) 
                {                       
                    if(getParent().isWaiting(table, "methods"))
                    {
                       getParent().setCalculated(table, "methods");
                       this.setValue(boConvertUtils.convertToBigDecimal(formula(), this), false );
                    }
                    else if(!getParent().isCalculated(table, "methods"))
                    {
                        getParent().setCalculated(table, "methods");
                        this.setValue(boConvertUtils.convertToBigDecimal(formula(), this), table );
                    }
                ...
                {   
                    ...
                    if(getParent().onChangeSubmit("methods"))
                    {                 
                        getParent().setWaiting(table, "methods");
                        getParent().calculateFormula(new Hashtable(table), "methods");
                        //getParent().setCalculated(table, "methods");
                    }                    
                }
            }
            ...
            public void setValue(BigDecimal newval, boolean recalc) throws boRuntimeException 
            {
                ...
                if( recalc && getParent().onChangeSubmit("methods"))
                {
                    Hashtable table = new Hashtable();
                    getParent().setCalculated(table, "methods");
                    getParent().calculateFormula(table, "methods");
				...
				if ( getParent().p_parentBridgeRow != null )
				{
					getParent().getParentBridgeRow().getBridge().lineChanged("methods");
				}
            }
...
	netgest.bo.security.securityRights.cleanObjectPolicies();
