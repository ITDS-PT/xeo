...
public  class Ebo_Method extends boObject implements  Serializable {  
    ...
    public Ebo_Method() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("Ebo_Method");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("Ebo_Method".equals(this.getName()))
            {
