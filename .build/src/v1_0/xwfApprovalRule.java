...
public  class xwfApprovalRule extends boObject implements  Serializable {  
    ...
    public netgest.bo.runtime.attributes.boAttributeObject pollDefinition;    
    ...
    public xwfApprovalRule() {
        super();
        bo_version      = "1.0";
        bo_name         = "xwfApprovalRule";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("xwfApprovalRule");
        ...
        atts.add(pollDefinition = new netgest.bo.runtime.attributes.boAttributeObject(this,"pollDefinition"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( pollDefinition.haveDefaultValue()) 
                {
                	if(pollDefinition.defaultValue() != null)
                	{
                    	pollDefinition._setValue(boConvertUtils.convertToBigDecimal(pollDefinition.defaultValue(), pollDefinition));
                    }
                    else
                    {
                    	pollDefinition._setValue(null);
                    }
                    pollDefinition.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("xwfApprovalRule".equals(this.getName()))
            {
