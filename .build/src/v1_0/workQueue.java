...
public  class workQueue extends boObject implements  Serializable {  
    ...
    public workQueue() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("workQueue");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("workQueue".equals(this.getName()))
            {
    ...
    public bridgeHandler getBridge( String bridgeName ) 
    {
        ...
        if( ret == null )
        {
        	...
        	{
            	brig.add( ret=new BridgeHandleradministrator(new DataResultSet( getDataRow().getRecordChild( getEboContext() ,"administrator") ) , this ) );        
        	}
...
	return netgest.bo.events.MailAccountEvents.inactiveMailAccounts(this,"emailAccounts");
