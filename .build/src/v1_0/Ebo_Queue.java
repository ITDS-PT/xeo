...
public  class Ebo_Queue extends netgest.bo.impl.Ebo_QueueImpl implements  Serializable {  
    ...
    public netgest.bo.runtime.attributes.boAttributeNumber executed;    
    public netgest.bo.runtime.attributes.boAttributeString errormessage;    
    public netgest.bo.runtime.attributes.boAttributeObject fromperf;    
    public netgest.bo.runtime.attributes.boAttributeObject toperf;    
    public netgest.bo.runtime.attributes.boAttributeDate afterDate;    
    ...
    public Ebo_Queue() {
        ...
        bo_definition   = boDefHandler.getBoDefinition("Ebo_Queue");
        ...
        atts.add(executed = new netgest.bo.runtime.attributes.boAttributeNumber(this,"executed"));
        
        atts.add(errormessage = new netgest.bo.runtime.attributes.boAttributeString(this,"errormessage"));
        
        atts.add(fromperf = new netgest.bo.runtime.attributes.boAttributeObject(this,"fromperf"));
        
        atts.add(toperf = new netgest.bo.runtime.attributes.boAttributeObject(this,"toperf"));
        
        atts.add(afterDate = new netgest.bo.runtime.attributes.boAttributeDate(this,"afterDate"));
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
                ...
                if( executed.haveDefaultValue()) 
                {
                	if(executed.defaultValue() != null)
                	{
                    	executed._setValue(boConvertUtils.convertToBigDecimal(executed.defaultValue(), executed));
                    }
                    else
                    {
                    	executed._setValue(null);
                    }
                    executed.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
                ...
                if( fromperf.haveDefaultValue()) 
                {
                	if(fromperf.defaultValue() != null)
                	{
                    	fromperf._setValue(boConvertUtils.convertToBigDecimal(fromperf.defaultValue(), fromperf));
                    }
                    else
                    {
                    	fromperf._setValue(null);
                    }
                    fromperf.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( toperf.haveDefaultValue()) 
                {
                	if(toperf.defaultValue() != null)
                	{
                    	toperf._setValue(boConvertUtils.convertToBigDecimal(toperf.defaultValue(), toperf));
                    }
                    else
                    {
                    	toperf._setValue(null);
                    }
                    toperf.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            
                if( afterDate.haveDefaultValue()) 
                {
                	if(afterDate.defaultValue() != null)
                	{
                    	afterDate._setValue(boConvertUtils.convertToTimestamp(afterDate.defaultValue(), afterDate));
                    }
                    else
                    {
                    	afterDate._setValue(null);
                    }
                    afterDate.setInputType( AttributeHandler.INPUT_FROM_DEFAULT );
                }
            ...
            if("Ebo_Queue".equals(this.getName()))
            {
