...
public  class horario_dia_periodo extends boObject implements  Serializable {  
    ...
    public horario_dia_periodo() {
        super();
        bo_version      = "1.0";
        bo_name         = "horario_dia_periodo";
        bo_classregboui = "#BO.CLSREGBOUI#";
        bo_definition   = boDefHandler.getBoDefinition("horario_dia_periodo");
    ...
    public void init() throws boRuntimeException {
        ...
        if(p_mode == MODE_NEW && !p_clone)
        {
            ...
            if("horario_dia_periodo".equals(this.getName()))
            {
