...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitychoice_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Actividade de escolha multipla';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g18662481");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfActivityChoice");  grid = DOC.createGRID("g18662481","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitychoice_generallist.jsp'>
