...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_template_generalidentification.jsp");
    return;
}
if(boctx==null) {
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_template_generalidentification.jsp'>
