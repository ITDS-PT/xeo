...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitypoll_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Actividade de votação';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g2930817");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfActivityPoll");  grid = DOC.createGRID("g2930817","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitypoll_generallist.jsp'>
