...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=holiday_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Feriado';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g17500912");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("holiday");  grid = DOC.createGRID("g17500912","std");
  grid.setTitle();  
if ( ( BOI != null && BOI.getAttribute("day").hasRights() ) || securityRights.hasRights( DOC.getEboContext() , currObjectList.getBoDef().getName() ,"day", securityRights.READ )){
xattributes=new Hashtable();
xattributes.put("width","50");grid.addColAtr(bodef.getAttributeRef("day"),50,xattributes);
...
xattributes=new Hashtable();
xattributes.put("width","400");grid.addColAtr(bodef.getAttributeRef("description"),400,xattributes);
}} //endCreategrid
...
<%}%>
<FORM name='boFormSubmit' method='post' action='holiday_generallist.jsp'>
