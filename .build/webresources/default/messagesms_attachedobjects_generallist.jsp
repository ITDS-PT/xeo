...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagesms_attachedobjects_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g18896253");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("messageSMS").getAttributeRef("attachedObjects").getBridge();  grid = DOC.createGRID("g18896253","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagesms_attachedobjects_generallist.jsp'>
