...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitydecision_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Actividade de decisão';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g13213657");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfActivityDecision");  grid = DOC.createGRID("g13213657","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitydecision_generallist.jsp'>
