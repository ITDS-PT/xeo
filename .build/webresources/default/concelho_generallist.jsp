...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=concelho_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Concelho';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g19116348");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("concelho");  grid = DOC.createGRID("g19116348","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='concelho_generallist.jsp'>
