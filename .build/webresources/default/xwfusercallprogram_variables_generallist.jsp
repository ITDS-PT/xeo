...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfusercallprogram_variables_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g29458826");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVariable");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfUserCallProgram").getAttributeRef("variables").getBridge();  grid = DOC.createGRID("g29458826","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfusercallprogram_variables_generallist.jsp'>
