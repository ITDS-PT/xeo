...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messageinternal_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g14738505");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("messageInternal");  grid = DOC.createGRID("g14738505","std");
  grid.setTitle();  
...
xattributes=new Hashtable();
xattributes.put("width","100");grid.addColAtr(bodef.getAttributeRef("from"),100,"","",xattributes);
}} //endCreategrid
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messageinternal_generallist.jsp'>
