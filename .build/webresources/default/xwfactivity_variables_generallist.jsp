...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivity_variables_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g8646406");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVariable");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfActivity").getAttributeRef("variables").getBridge();  grid = DOC.createGRID("g8646406","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivity_variables_generallist.jsp'>
