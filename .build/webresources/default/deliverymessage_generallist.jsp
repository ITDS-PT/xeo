...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=deliverymessage_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g23713005");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("deliveryMessage");  grid = DOC.createGRID("g23713005","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='deliverymessage_generallist.jsp'>
