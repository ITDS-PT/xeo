...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagefax_attachedobjects_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g714429");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("messageFax").getAttributeRef("attachedObjects").getBridge();  grid = DOC.createGRID("g714429","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagefax_attachedobjects_generallist.jsp'>
