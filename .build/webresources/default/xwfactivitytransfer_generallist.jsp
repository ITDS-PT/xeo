...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitytransfer_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Transferir';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g3799869");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfActivityTransfer");  grid = DOC.createGRID("g3799869","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitytransfer_generallist.jsp'>
