...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=uiprofile_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Perfil de Utilizador';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g8726015");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("uiProfile");  grid = DOC.createGRID("g8726015","");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='uiprofile_generallist.jsp'>
