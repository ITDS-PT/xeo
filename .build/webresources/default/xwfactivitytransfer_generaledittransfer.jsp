...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitytransfer_generaledittransfer.jsp");
    return;
}
if(boctx==null) {
         ...
         <TR>
            <TD><%if (DOC.hasCategoryRights("settings")){ %>
               <DIV id="<%=DOCLIST.cvui%>_tabbody_0" class="tab" style="overflow-y:auto">
                  <%{ int cvui23886806=DOCLIST.cvui;%>
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s20325493");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s20325493","");
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitytransfer_generaledittransfer.jsp'>
