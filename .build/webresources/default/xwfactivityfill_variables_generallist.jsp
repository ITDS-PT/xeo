...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivityfill_variables_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g3393361");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVariable");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfActivityFill").getAttributeRef("variables").getBridge();  grid = DOC.createGRID("g3393361","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivityfill_variables_generallist.jsp'>
