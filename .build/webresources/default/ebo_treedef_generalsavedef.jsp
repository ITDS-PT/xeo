...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_treedef_generalsavedef.jsp");
    return;
}
if(boctx==null) {
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_treedef_generalsavedef.jsp'>
