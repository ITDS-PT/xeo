...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_docbase_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Documento Base';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g12391077");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_DocBase");  grid = DOC.createGRID("g12391077","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_docbase_generallist.jsp'>
