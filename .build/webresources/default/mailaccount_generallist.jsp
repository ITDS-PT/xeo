...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=mailaccount_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g13879234");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("mailAccount");  grid = DOC.createGRID("g13879234","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='mailaccount_generallist.jsp'>
