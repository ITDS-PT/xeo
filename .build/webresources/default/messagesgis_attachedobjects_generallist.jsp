...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagesgis_attachedobjects_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g31250915");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("messageSgis").getAttributeRef("attachedObjects").getBridge();  grid = DOC.createGRID("g31250915","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagesgis_attachedobjects_generallist.jsp'>
