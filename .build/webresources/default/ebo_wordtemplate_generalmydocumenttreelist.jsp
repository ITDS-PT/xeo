...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_wordtemplate_generalmydocumenttreelist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
boDefHandler xbodef = boDefHandler.getBoDefinition( "Ebo_WordTemplate");
...
%>
<script> window.gridKey='12834118'</script>  

</form>
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_wordtemplate_generalmydocumenttreelist.jsp'>
