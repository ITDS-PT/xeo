...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ixeouser_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Utilizador';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g32735768");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("iXEOUser");  grid = DOC.createGRID("g32735768","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ixeouser_generallist.jsp'>
