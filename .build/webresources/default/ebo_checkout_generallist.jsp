...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_checkout_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Check Out';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g17031297");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_CheckOut");  grid = DOC.createGRID("g17031297","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_checkout_generallist.jsp'>
