...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=imo_ti_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Imovel TI';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g8321933");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("imo_ti");  grid = DOC.createGRID("g8321933","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='imo_ti_generallist.jsp'>
