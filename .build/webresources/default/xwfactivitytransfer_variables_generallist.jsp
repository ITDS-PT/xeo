...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitytransfer_variables_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g33073512");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVariable");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfActivityTransfer").getAttributeRef("variables").getBridge();  grid = DOC.createGRID("g33073512","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitytransfer_variables_generallist.jsp'>
