...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_clsreg_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Objectos no Sistema';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g20833034");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_ClsReg");  grid = DOC.createGRID("g20833034","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_clsreg_generallist.jsp'>
