...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=supplier_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Fornecedor';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g1064020");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("supplier");  grid = DOC.createGRID("g1064020","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='supplier_generallist.jsp'>
