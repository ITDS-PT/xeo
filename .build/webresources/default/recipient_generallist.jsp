...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=recipient_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Recipiente';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g24356272");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("recipient");  grid = DOC.createGRID("g24356272","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='recipient_generallist.jsp'>
