...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=uilistbar_content_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g16349398");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("uiListBar").getAttributeRef("content").getBridge();  grid = DOC.createGRID("g16349398","",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='uilistbar_content_generallist.jsp'>
