...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_treedef_share_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g1956354");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("Ebo_treeDef").getAttributeRef("share").getBridge();  grid = DOC.createGRID("g1956354","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_treedef_share_generallist.jsp'>
