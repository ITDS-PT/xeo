...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_classification_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Classificação';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g1999013");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Classification");  grid = DOC.createGRID("g1999013","std");
  grid.setTitle();  
...
xattributes=new Hashtable();
xattributes.put("width","40");grid.addColAtr(bodef.getAttributeRef("code"),40,xattributes);
}} //endCreategrid
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_classification_generallist.jsp'>
