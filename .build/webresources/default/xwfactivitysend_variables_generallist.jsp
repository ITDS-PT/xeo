...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitysend_variables_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g26933714");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVariable");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfActivitySend").getAttributeRef("variables").getBridge();  grid = DOC.createGRID("g26933714","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitysend_variables_generallist.jsp'>
