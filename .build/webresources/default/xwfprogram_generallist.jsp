...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfprogram_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g2657966");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfProgram");  grid = DOC.createGRID("g2657966","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfprogram_generallist.jsp'>
