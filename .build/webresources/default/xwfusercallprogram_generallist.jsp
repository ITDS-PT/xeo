...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfusercallprogram_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Preencher';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g18847803");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfUserCallProgram");  grid = DOC.createGRID("g18847803","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfusercallprogram_generallist.jsp'>
