...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagereceipt_generaleditantigo.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Recibo de leitura';</script>
                        ...
                        <TR>
                           <TD><%if (DOC.hasCategoryRights("settings")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_0" class="tab">
                                 <%{ int cvui956597=DOCLIST.cvui;%>
                                 <%
BOI=currObjectList.getObject();sec = DOC.getSection("s4954696");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s4954696","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                                 ...
                                 <%DOCLIST.cvui=cvui956597;}%>
                              </DIV>
                              <%}%>
                              <%if (DOC.hasCategoryRights("settingsRES")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_1" class="tab">
                                 <%{ int cvui25042524=DOCLIST.cvui;%>
                                 <%
BOI=currObjectList.getObject();sec = DOC.getSection("s16460750");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s16460750","");
  sec.p_name = "section_settingsRES";
  sec.p_id = "section_settingsRES";
sec.p_showLabel=false;
  bodef=boDefHandler.getBoDefinition("messageReceipt");  sec.setTitle("");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                                 ...
                                 <%DOCLIST.cvui=cvui25042524;}%>
                              </DIV>
                              <%}%>
                              <%if (DOC.hasCategoryRights("options")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_2" class="tab">
                                 <%{ int cvui33097949=DOCLIST.cvui;%>
                                 <table>
                                    <tr height="60px">
                                       <td>
                                          <%
BOI=currObjectList.getObject();sec = DOC.getSection("s11871687");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s11871687","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                  ...
                  <%}%>
                  <%DOCLIST.cvui=cvui27619025;}%>
               </DIV>
               <%}%>
               <%if (DOC.hasCategoryRights("documents")){ %>
               <DIV id="barea_<%=DOCLIST.cvui%>_1" class="area">
                  <%{ int cvui20417058=DOCLIST.cvui;%>
                  ...
                  <%}%>
                  <%DOCLIST.cvui=cvui20417058;}%>
               </DIV>
               <%}%>
               <%if (DOC.hasCategoryRights("attachedObjects")){ %>
               <DIV id="barea_<%=DOCLIST.cvui%>_2" class="area">
                  <%{ int cvui20362719=DOCLIST.cvui;%>
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagereceipt_generaleditantigo.jsp'>
