...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_role_emailaccounts_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Funcão';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g21710557");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("mailAccount");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("Ebo_Role").getAttributeRef("emailAccounts").getBridge();  grid = DOC.createGRID("g21710557","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_role_emailaccounts_generallist.jsp'>
