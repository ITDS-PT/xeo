...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagesgis_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g30317337");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("messageSgis");  grid = DOC.createGRID("g30317337","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagesgis_generallist.jsp'>
