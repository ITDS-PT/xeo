...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=uitreelb_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Árvore';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g13037491");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("uiTreeLB");  grid = DOC.createGRID("g13037491","");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='uitreelb_generallist.jsp'>
