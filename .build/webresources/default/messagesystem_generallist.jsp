...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagesystem_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g32559723");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("messageSystem");  grid = DOC.createGRID("g32559723","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagesystem_generallist.jsp'>
