...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=distrito_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Distrito';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g23151623");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("distrito");  grid = DOC.createGRID("g23151623","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='distrito_generallist.jsp'>
