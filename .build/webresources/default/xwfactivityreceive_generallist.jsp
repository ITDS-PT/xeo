...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivityreceive_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g14770542");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfActivityReceive");  grid = DOC.createGRID("g14770542","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivityreceive_generallist.jsp'>
