...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_policyrule_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g33311464");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_PolicyRule");  grid = DOC.createGRID("g33311464","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_policyrule_generallist.jsp'>
