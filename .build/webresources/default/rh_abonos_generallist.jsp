...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=rh_abonos_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Abonos';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g5067092");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("rh_abonos");  grid = DOC.createGRID("g5067092","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='rh_abonos_generallist.jsp'>
