...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=imobilizado_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Imovel';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g11847568");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("imobilizado");  grid = DOC.createGRID("g11847568","std");
  grid.setTitle();  
...
xattributes=new Hashtable();
xattributes.put("width","40");grid.addColAtr(bodef.getAttributeRef("id"),40,xattributes);
}} //endCreategrid
...
<%}%>
<FORM name='boFormSubmit' method='post' action='imobilizado_generallist.jsp'>
