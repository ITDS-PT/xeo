...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_application_packages_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g15589349");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Package");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("Ebo_Application").getAttributeRef("packages").getBridge();  grid = DOC.createGRID("g15589349","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_application_packages_generallist.jsp'>
