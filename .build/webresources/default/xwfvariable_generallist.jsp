...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfvariable_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Variavel';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g32507743");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVariable");  grid = DOC.createGRID("g32507743","std");
  grid.setTitle();  
...
xattributes.put("width","100");grid.addColAtr(bodef.getAttributeRef("label"),100,xattributes);
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfvariable_generallist.jsp'>
