...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=uilistbar_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Lista de Opções';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g7098382");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("uiListBar");  grid = DOC.createGRID("g7098382","");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='uilistbar_generallist.jsp'>
