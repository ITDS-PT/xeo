...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=supplier_generalidentification.jsp");
    return;
}
if(boctx==null) {
...
<%}%>
<FORM name='boFormSubmit' method='post' action='supplier_generalidentification.jsp'>
