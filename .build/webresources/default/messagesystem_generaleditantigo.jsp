...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagesystem_generaleditantigo.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Email de Sistema';</script>
                        ...
                        <TR>
                           <TD><%if (DOC.hasCategoryRights("settings")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_0" class="tab">
                                 <%{ int cvui22559351=DOCLIST.cvui;%>
                                 <%
BOI=currObjectList.getObject();sec = DOC.getSection("s23499971");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s23499971","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                                 ...
                                 <%DOCLIST.cvui=cvui22559351;}%>
                              </DIV>
                              <%}%>
                              <%if (DOC.hasCategoryRights("settingsRES")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_1" class="tab">
                                 <%{ int cvui28359433=DOCLIST.cvui;%>
                                 <%
BOI=currObjectList.getObject();sec = DOC.getSection("s29840363");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s29840363","");
  sec.p_name = "section_settingsRES";
  sec.p_id = "section_settingsRES";
sec.p_showLabel=false;
  bodef=boDefHandler.getBoDefinition("messageSystem");  sec.setTitle("");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                                 ...
                                 <%DOCLIST.cvui=cvui28359433;}%>
                              </DIV>
                              <%}%>
                              <%if (DOC.hasCategoryRights("options")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_2" class="tab">
                                 <%{ int cvui22443916=DOCLIST.cvui;%>
                                 <table>
                                    <tr height="60px">
                                       <td>
                                          <%
BOI=currObjectList.getObject();sec = DOC.getSection("s29533891");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s29533891","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                  ...
                  <%}%>
                  <%DOCLIST.cvui=cvui25597901;}%>
               </DIV>
               <%}%>
               <%if (DOC.hasCategoryRights("documents")){ %>
               <DIV id="barea_<%=DOCLIST.cvui%>_1" class="area">
                  <%{ int cvui8873237=DOCLIST.cvui;%>
                  ...
                  <%}%>
                  <%DOCLIST.cvui=cvui8873237;}%>
               </DIV>
               <%}%>
               <%if (DOC.hasCategoryRights("attachedObjects")){ %>
               <DIV id="barea_<%=DOCLIST.cvui%>_2" class="area">
                  <%{ int cvui13026502=DOCLIST.cvui;%>
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagesystem_generaleditantigo.jsp'>
