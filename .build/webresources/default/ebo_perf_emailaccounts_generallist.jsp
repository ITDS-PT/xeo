...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_perf_emailaccounts_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Funcionário';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g18680524");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("mailAccount");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("Ebo_Perf").getAttributeRef("emailAccounts").getBridge();  grid = DOC.createGRID("g18680524","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_perf_emailaccounts_generallist.jsp'>
