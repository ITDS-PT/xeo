...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_role_generalidentification.jsp");
    return;
}
if(boctx==null) {
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_role_generalidentification.jsp'>
