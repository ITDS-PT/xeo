...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfannounce_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g32666076");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfAnnounce");  grid = DOC.createGRID("g32666076","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfannounce_generallist.jsp'>
