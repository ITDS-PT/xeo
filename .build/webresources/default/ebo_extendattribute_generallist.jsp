...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_extendattribute_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g29128598");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_ExtendAttribute");  grid = DOC.createGRID("g29128598","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_extendattribute_generallist.jsp'>
