...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfdefactivity_generalwizard.jsp");
    return;
}
if(boctx==null) {
...
<script>
<%=DOC.getScriptToRunOnClient()%>  function runStart(){
     if(document.getElementById("refreshframe") != null)
     document.getElementById("refreshframe").contentWindow.BindToWizzard('start');
  }
  function runPrevious(){
     if(document.getElementById("refreshframe") != null)
     document.getElementById("refreshframe").contentWindow.BindToWizzard('buttonPrevious');
  }
  function runNext(){
     if(document.getElementById("refreshframe") != null)
     document.getElementById("refreshframe").contentWindow.BindToWizzard('buttonNext');
  }
  function runEnd(){
     if(boForm != null)
     boForm.SaveAndClose(); savePressed(true);wait();
  }
</script>
<script>var objLabel='Lista de  Nova tarefa no fluxo de trabalho';</script>
...
<%if (scriptToRun==null) {%>
<body ondragenter="activethis()" onload=" <%=DOC.getActionOnClient()%>; runAfterMethodExec();runStart(); treatFocus(); ">
<%}
else{%>
<body ondragenter="activethis()" onload=" <%=scriptToRun%>; runAfterMethodExec();runStart(); treatFocus(); ">
<%
}
%>
<%if ( request.getParameter("boFormSubmitXml")!= null && request.getParameter("actRenderObj") != null && ( BOI!=null && BOI.exists() )){%>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <TABLE id="<%=DOCLIST.cvui%>" class="layout" voui="panel" cellspacing="0" cellpadding="0">
      <TBODY>
                  ...
                  <TBODY>
                     <TR>
                        <TD style="padding:0px" id="<%=DOCLIST.cvui%>_tabs" valign="bottom" noWrap="yes">
                           <%if (DOC.hasCategoryRights("periodicidade")){ %><SPAN class="tab tabOn" id="<%=DOCLIST.cvui%>_tabheader_0" name="tab_periodicidade" tabNumber="<%=DOCLIST.cvui%>" tabIndex="<%=DOC.getTabindex(DOC.PANEL, BOI==null?"tab_periodicidade" : BOI.getName(), String.valueOf(BOI==null?0:BOI.bo_boui), String.valueOf(DOCLIST.cvui) + "_tabheader_0", DOCLIST)%>">Atribuir Acção</SPAN><%}%>
                        </TD>
                     </TR>
                  </TBODY>
               </TABLE>
         ...
         <TR>
            <TD><%if (DOC.hasCategoryRights("periodicidade")){ %>
               <DIV id="<%=DOCLIST.cvui%>_tabbody_0" class="tab" style="overflow-y:auto">
                  <%{ int cvui29571565=DOCLIST.cvui;%>
                  <table>
                     <TR>
                        <TD>
                           <table class="messageZone" id="messageZone">
                              <TR>
                                 <TD/>
                              </TR>
                           </table>
                     ...
                     <tr>
                        <td>
                           <%
BOI=currObjectList.getObject();sec = DOC.getSection("s1060583");
if(sec != null)
  sec.setTitle("Preencha os seguintes campos");
if(sec==null) { 
  sec = DOC.createSection("s1060583","");
  sec.p_name = "section_taskDef";
  sec.p_id = "section_taskDef";
  bodef=boDefHandler.getBoDefinition("xwfDefActivity");  sec.setTitle("Preencha os seguintes campos");
  sec.p_height="400px";
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                     ...
                     <tr>
                        <td>
                           <%
BOI=currObjectList.getObject();sec = DOC.getSection("s7820874");
if(sec != null)
  sec.setTitle("Indique se a tarefa é recursiva");
if(sec==null) { 
  sec = DOC.createSection("s7820874","");
  sec.p_name = "section_recursive";
  sec.p_id = "section_recursive";
  bodef=boDefHandler.getBoDefinition("xwfDefActivity");  sec.setTitle("Indique se a tarefa é recursiva");
  sec.p_height="100%";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                     ...
                     <tr>
                        <td>
                           <%
BOI=currObjectList.getObject();sec = DOC.getSection("s12731052");
if(sec != null)
  sec.setTitle("Preencha a data de Início e Fim da tarefa");
if(sec==null) { 
  sec = DOC.createSection("s12731052","");
  sec.p_name = "section_simpletaskTimes";
  sec.p_id = "section_simpletaskTimes";
  bodef=boDefHandler.getBoDefinition("xwfDefActivity");  sec.setTitle("Preencha a data de Início e Fim da tarefa");
  sec.p_height="100%";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                     ...
                     <tr>
                        <td>
                           <%
BOI=currObjectList.getObject();sec = DOC.getSection("s27743136");
if(sec != null)
  sec.setTitle("Tipo Periodicidade");
if(sec==null) { 
  sec = DOC.createSection("s27743136","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                     ...
                     <tr>
                        <td>
                           <%
BOI=currObjectList.getObject();sec = DOC.getSection("s6499897");
if(sec != null)
  sec.setTitle("Vigência da tarefa");
if(sec==null) { 
  sec = DOC.createSection("s6499897","");
  sec.p_name = "section_vigencia";
  sec.p_id = "section_vigencia";
  bodef=boDefHandler.getBoDefinition("xwfDefActivity");  sec.setTitle("Vigência da tarefa");
  docHTML_sectionRow row; 
...
xattributes=new Hashtable();
xattributes.put("showlabel","yes");row.addCell(bodef.getAttributeRef("vig_duration"),xattributes);
} else row.addCell();
} 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                     ...
                     <tr>
                        <td>
                           <%
BOI=currObjectList.getObject();sec = DOC.getSection("s24094870");
if(sec != null)
  sec.setTitle("Horária");
if(sec==null) { 
  sec = DOC.createSection("s24094870","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                     ...
                     <tr>
                        <td>
                           <%
BOI=currObjectList.getObject();sec = DOC.getSection("s27607245");
if(sec != null)
  sec.setTitle("Diária");
if(sec==null) { 
  sec = DOC.createSection("s27607245","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                     ...
                     <tr>
                        <td>
                           <%
BOI=currObjectList.getObject();sec = DOC.getSection("s4284648");
if(sec != null)
  sec.setTitle("Semanal");
if(sec==null) { 
  sec = DOC.createSection("s4284648","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                     ...
                     <tr>
                        <td>
                           <%
BOI=currObjectList.getObject();sec = DOC.getSection("s4284441");
if(sec != null)
  sec.setTitle("Mensal");
if(sec==null) { 
  sec = DOC.createSection("s4284441","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                     ...
                     <tr>
                        <td>
                           <%
BOI=currObjectList.getObject();sec = DOC.getSection("s804342");
if(sec != null)
  sec.setTitle("Anual");
if(sec==null) { 
  sec = DOC.createSection("s804342","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                     ...
                     <tr>
                        <td>
                           <%
BOI=currObjectList.getObject();sec = DOC.getSection("s29702477");
if(sec != null)
  sec.setTitle("As acções deverão ser geradas apenas:");
if(sec==null) { 
  sec = DOC.createSection("s29702477","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                     ...
                     <tr>
                        <td>
                           <%
BOI=currObjectList.getObject();sec = DOC.getSection("s20249196");
if(sec != null)
  sec.setTitle("Retorno da tarefa");
if(sec==null) { 
  sec = DOC.createSection("s20249196","");
  sec.p_name = "section_taskReturn";
  sec.p_id = "section_taskReturn";
  bodef=boDefHandler.getBoDefinition("xwfDefActivity");  sec.setTitle("Retorno da tarefa");
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                     ...
                     <TR>
                        <TD>
                           <table class="section" cellspacing="0" cellpadding="1">
                              <TR>
                                 <TD height="24px">&nbsp</TD>
                                 <TD height="24px" valign="top" align="right">
                                    <button id="buttonPrevious" style="background:url(resources/wizPrevious.gif) no-repeat center left;filter:0; width:100%" onClick="runPrevious();">Anterior</button>
                                 </TD>
                                 <TD height="24px" valign="top" align="right">
                                    <button id="buttonNext" style="background:url(resources/wizNext.gif) no-repeat center right;filter:0; width:100%" onClick="runNext();">Próximo</button>
                                 </TD>
                                 <TD height="24px" valign="top" align="right">
                                    <button id="buttonEnd" style="background:url(resources/wizEnd.gif) no-repeat center left;filter:0; width:100%" onClick="runEnd();">Terminar</button>
                                 </TD>
                                 <TD height="24px" valign="top" align="right">
                                    <button id="buttonCancel" style="background:url(resources/wizCancel.gif) no-repeat center left;filter:0; width:100%" onClick="boForm.Close();">Cancelar</button>
                                 </TD>
                              </TR>
                           </table>
                        </TD>
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfdefactivity_generalwizard.jsp'>
