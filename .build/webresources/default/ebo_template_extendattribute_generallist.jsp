...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_template_extendattribute_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g7382185");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_ExtendAttribute");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("Ebo_Template").getAttributeRef("extendAttribute").getBridge();  grid = DOC.createGRID("g7382185","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_template_extendattribute_generallist.jsp'>
