...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagemail_attachedobjects_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g4090516");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("messageMail").getAttributeRef("attachedObjects").getBridge();  grid = DOC.createGRID("g4090516","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagemail_attachedobjects_generallist.jsp'>
