...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=uiworkplace_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Mesa de Trabalho';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g33216153");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("uiWorkPlace");  grid = DOC.createGRID("g33216153","");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='uiworkplace_generallist.jsp'>
