...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_log_generaledit.jsp");
    return;
}
if(boctx==null) {
...
if ((BOI==null && securityRights.hasRights(boctx,"Ebo_Log")) || 
(BOI!=null && BOI.exists() && securityRights.hasRights(boctx,"Ebo_Log") && securityOPL.canRead(BOI)) || 
(BOI!=null && !BOI.exists() && securityRights.hasRights(boctx,"Ebo_Log",securityRights.ADD)) 
) {
if (BOI!=null && BOI.exists() && !BOI.isEnabledforRequest &&(!securityRights.hasRights(boctx,"Ebo_Log",securityRights.WRITE) ||  !securityOPL.canWrite(BOI) && !BOI.isEnabledforRequest)) { 
  BOI.setDisabled(); }
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_log_generaledit.jsp'>
