...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messageletter_attachedobjects_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g24863760");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("messageLetter").getAttributeRef("attachedObjects").getBridge();  grid = DOC.createGRID("g24863760","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messageletter_attachedobjects_generallist.jsp'>
