...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_flag_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Flag';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g29222978");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Flag");  grid = DOC.createGRID("g29222978","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_flag_generallist.jsp'>
