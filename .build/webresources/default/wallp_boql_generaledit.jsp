...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=wallp_boql_generaledit.jsp");
    return;
}
if(boctx==null) {
...
if ((BOI==null && securityRights.hasRights(boctx,"wallp_boql")) || 
(BOI!=null && BOI.exists() && securityRights.hasRights(boctx,"wallp_boql") && securityOPL.canRead(BOI)) || 
(BOI!=null && !BOI.exists() && securityRights.hasRights(boctx,"wallp_boql",securityRights.ADD)) 
) {
if (BOI!=null && BOI.exists() && !BOI.isEnabledforRequest &&(!securityRights.hasRights(boctx,"wallp_boql",securityRights.WRITE) ||  !securityOPL.canWrite(BOI) && !BOI.isEnabledforRequest)) { 
  BOI.setDisabled(); }
...
<%}%>
<FORM name='boFormSubmit' method='post' action='wallp_boql_generaledit.jsp'>
