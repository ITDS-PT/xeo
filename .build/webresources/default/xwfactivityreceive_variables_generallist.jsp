...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivityreceive_variables_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g22375857");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVariable");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfActivityReceive").getAttributeRef("variables").getBridge();  grid = DOC.createGRID("g22375857","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivityreceive_variables_generallist.jsp'>
