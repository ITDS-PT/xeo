...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfvarvalue_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g4007155");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVarValue");  grid = DOC.createGRID("g4007155","std");
  grid.setTitle();  
} //endCreategrid
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfvarvalue_generallist.jsp'>
