...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_lov_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Lista de Valores';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g17100439");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_LOV");  grid = DOC.createGRID("g17100439","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_lov_generallist.jsp'>
