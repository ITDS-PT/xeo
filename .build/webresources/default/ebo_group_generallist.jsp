...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_group_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g561474");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Group");  grid = DOC.createGRID("g561474","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_group_generallist.jsp'>
