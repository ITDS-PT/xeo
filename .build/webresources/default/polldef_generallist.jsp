...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=polldef_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Definções de Votação';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g13692890");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("PollDef");  grid = DOC.createGRID("g13692890","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='polldef_generallist.jsp'>
