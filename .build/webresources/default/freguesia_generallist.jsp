...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=freguesia_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Freguesia';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g26773830");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("freguesia");  grid = DOC.createGRID("g26773830","std");
  grid.setTitle();  
...
xattributes=new Hashtable();
xattributes.put("width","100");grid.addColAtr(bodef.getAttributeRef("id"),100,xattributes);
}} //endCreategrid
...
<%}%>
<FORM name='boFormSubmit' method='post' action='freguesia_generallist.jsp'>
