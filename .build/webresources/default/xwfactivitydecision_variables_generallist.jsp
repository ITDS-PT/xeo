...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitydecision_variables_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g26222236");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVariable");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfActivityDecision").getAttributeRef("variables").getBridge();  grid = DOC.createGRID("g26222236","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitydecision_variables_generallist.jsp'>
