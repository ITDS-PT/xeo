...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_template_templateowners_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g26354517");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("Ebo_Template").getAttributeRef("templateOwners").getBridge();  grid = DOC.createGRID("g26354517","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_template_templateowners_generallist.jsp'>
