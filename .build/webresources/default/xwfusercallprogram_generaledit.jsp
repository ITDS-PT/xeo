...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfusercallprogram_generaledit.jsp");
    return;
}
if(boctx==null) {
...
if ((BOI==null && securityRights.hasRights(boctx,"xwfUserCallProgram")) || 
(BOI!=null && BOI.exists() && securityRights.hasRights(boctx,"xwfUserCallProgram") && securityOPL.canRead(BOI)) || 
(BOI!=null && !BOI.exists() && securityRights.hasRights(boctx,"xwfUserCallProgram",securityRights.ADD)) 
) {
if (BOI!=null && BOI.exists() && !BOI.isEnabledforRequest &&(!securityRights.hasRights(boctx,"xwfUserCallProgram",securityRights.WRITE) ||  !securityOPL.canWrite(BOI) && !BOI.isEnabledforRequest)) { 
  BOI.setDisabled(); }
         ...
         <TR>
            <TD><%if (DOC.hasCategoryRights("settings")){ %>
               <DIV id="<%=DOCLIST.cvui%>_tabbody_0" class="tab" style="overflow-y:auto">
                  <%{ int cvui21201532=DOCLIST.cvui;%>
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s19635344");
if(sec != null)
  sec.setTitle("Assunto");
if(sec==null) { 
  sec = DOC.createSection("s19635344","");
  sec.p_name = "section_settingslabelActivity";
  sec.p_id = "section_settingslabelActivity";
sec.p_showLabel=false;
  bodef=boDefHandler.getBoDefinition("xwfUserCallProgram");  sec.setTitle("Assunto");
  sec.p_height="20px";
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s3396970");
if(sec != null)
  sec.setTitle("Assunto");
if(sec==null) { 
  sec = DOC.createSection("s3396970","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s16792549");
if(sec != null)
  sec.setTitle("Descrição");
if(sec==null) { 
  sec = DOC.createSection("s16792549","");
  sec.p_name = "section_settingsDescActivity";
  sec.p_id = "section_settingsDescActivity";
  bodef=boDefHandler.getBoDefinition("xwfUserCallProgram");  sec.setTitle("Descrição");
  sec.p_height="200px";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s6057278");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s6057278","");
  sec.p_name = "section_settingsActivity";
  sec.p_id = "section_settingsActivity";
sec.p_showLabel=false;
  bodef=boDefHandler.getBoDefinition("xwfUserCallProgram");  sec.setTitle("");
  sec.p_height="20px";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s526543");
if(sec != null)
  sec.setTitle(DOC.getCategoryLabel("general","settings.prvDatesAndTimes"));
if(sec==null) { 
  sec = DOC.createSection("s526543","");
  sec.p_name = "section_prvDatas";
  sec.p_id = "section_prvDatas";
  bodef=boDefHandler.getBoDefinition("xwfUserCallProgram");  sec.setTitle(DOC.getCategoryLabel("general","settings.prvDatesAndTimes"));
  sec.p_height="40px";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s24803881");
if(sec != null)
  sec.setTitle(DOC.getCategoryLabel("general","settings.datesAndTimes"));
if(sec==null) { 
  sec = DOC.createSection("s24803881","");
  sec.p_name = "section_datas";
  sec.p_id = "section_datas";
  bodef=boDefHandler.getBoDefinition("xwfUserCallProgram");  sec.setTitle(DOC.getCategoryLabel("general","settings.datesAndTimes"));
  sec.p_height="80px";
  docHTML_sectionRow row; 
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfusercallprogram_generaledit.jsp'>
