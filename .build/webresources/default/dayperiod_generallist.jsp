...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=dayperiod_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g28151941");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("dayperiod");  grid = DOC.createGRID("g28151941","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='dayperiod_generallist.jsp'>
