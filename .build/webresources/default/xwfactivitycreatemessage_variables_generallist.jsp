...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitycreatemessage_variables_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g17701027");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVariable");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfActivityCreateMessage").getAttributeRef("variables").getBridge();  grid = DOC.createGRID("g17701027","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitycreatemessage_variables_generallist.jsp'>
