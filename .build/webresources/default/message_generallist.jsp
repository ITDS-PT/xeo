...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=message_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g1565417");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("message");  grid = DOC.createGRID("g1565417","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='message_generallist.jsp'>
