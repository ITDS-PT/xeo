...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagemail_generaleditantigo.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  E-Mail';</script>
                        ...
                        <TR>
                           <TD><%if (DOC.hasCategoryRights("settings")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_0" class="tab">
                                 <%{ int cvui10549876=DOCLIST.cvui;%>
                                 <%
BOI=currObjectList.getObject();sec = DOC.getSection("s10148114");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s10148114","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                                 ...
                                 <%DOCLIST.cvui=cvui10549876;}%>
                              </DIV>
                              <%}%>
                              <%if (DOC.hasCategoryRights("settingsRES")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_1" class="tab">
                                 <%{ int cvui2180786=DOCLIST.cvui;%>
                                 <%
BOI=currObjectList.getObject();sec = DOC.getSection("s11041604");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s11041604","");
  sec.p_name = "section_settingsRES";
  sec.p_id = "section_settingsRES";
sec.p_showLabel=false;
  bodef=boDefHandler.getBoDefinition("messageMail");  sec.setTitle("");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                                 ...
                                 <%DOCLIST.cvui=cvui2180786;}%>
                              </DIV>
                              <%}%>
                              <%if (DOC.hasCategoryRights("options")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_2" class="tab">
                                 <%{ int cvui20240584=DOCLIST.cvui;%>
                                 <table>
                                    <tr height="60px">
                                       <td>
                                          <%
BOI=currObjectList.getObject();sec = DOC.getSection("s8663830");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s8663830","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                  ...
                  <%}%>
                  <%DOCLIST.cvui=cvui30570358;}%>
               </DIV>
               <%}%>
               <%if (DOC.hasCategoryRights("documents")){ %>
               <DIV id="barea_<%=DOCLIST.cvui%>_1" class="area">
                  <%{ int cvui22249292=DOCLIST.cvui;%>
                  ...
                  <%}%>
                  <%DOCLIST.cvui=cvui22249292;}%>
               </DIV>
               <%}%>
               <%if (DOC.hasCategoryRights("attachedObjects")){ %>
               <DIV id="barea_<%=DOCLIST.cvui%>_2" class="area">
                  <%{ int cvui12163248=DOCLIST.cvui;%>
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagemail_generaleditantigo.jsp'>
