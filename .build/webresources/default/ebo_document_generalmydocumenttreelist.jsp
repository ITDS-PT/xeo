...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_document_generalmydocumenttreelist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
boDefHandler xbodef = boDefHandler.getBoDefinition( "Ebo_Document");
...
%>
<script> window.gridKey='19856206'</script>  

</form>
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_document_generalmydocumenttreelist.jsp'>
