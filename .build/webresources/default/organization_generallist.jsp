...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=organization_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g22736605");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Organization");  grid = DOC.createGRID("g22736605","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='organization_generallist.jsp'>
