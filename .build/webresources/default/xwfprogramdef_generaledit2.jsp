...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfprogramdef_generaledit2.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Versão de Fluxo de Trabalho';</script>
                        ...
                        <TR>
                           <TD><%if (DOC.hasCategoryRights("identification")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_0" class="tab">
                                 <%{ int cvui3024637=DOCLIST.cvui;%>
                                 <%
BOI=currObjectList.getObject();sec = DOC.getSection("s109602");
if(sec != null)
  sec.setTitle(DOC.getCategoryLabel("general","identification"));
if(sec==null) { 
  sec = DOC.createSection("s109602","");
  sec.p_name = "";
  sec.p_id = "";
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%}%>
                  <%DOCLIST.cvui=cvui29417955;}%>
               </DIV>
               <%}%>
               <%if (DOC.hasCategoryRights("identification")){ %>
               <DIV id="barea_<%=DOCLIST.cvui%>_1" class="area">
                  <%{ int cvui30152779=DOCLIST.cvui;%>
                  ...
                  <%}%>
                  <%DOCLIST.cvui=cvui30152779;}%>
               </DIV>
               <%}%>
               <%if (DOC.hasCategoryRights("identification")){ %>
               <DIV id="barea_<%=DOCLIST.cvui%>_2" class="area">
                  <%{ int cvui6057076=DOCLIST.cvui;%>
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfprogramdef_generaledit2.jsp'>
