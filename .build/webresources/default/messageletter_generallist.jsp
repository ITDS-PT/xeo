...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messageletter_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g1075259");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("messageLetter");  grid = DOC.createGRID("g1075259","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messageletter_generallist.jsp'>
