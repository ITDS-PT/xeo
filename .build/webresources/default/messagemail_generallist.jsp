...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagemail_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g13394002");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("messageMail");  grid = DOC.createGRID("g13394002","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagemail_generallist.jsp'>
