...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfperformerconfig_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Configuração de Utilizadores dos Fluxos de Trabalho';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g10600201");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfPerformerConfig");  grid = DOC.createGRID("g10600201","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfperformerconfig_generallist.jsp'>
