...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_document_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g24431308");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Document");  grid = DOC.createGRID("g24431308","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_document_generallist.jsp'>
