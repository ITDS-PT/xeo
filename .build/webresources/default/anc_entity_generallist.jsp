...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=anc_entity_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Entidade';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g25888905");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("ANC_entity");  grid = DOC.createGRID("g25888905","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='anc_entity_generallist.jsp'>
