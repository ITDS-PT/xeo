...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagesms_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g30196415");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("messageSMS");  grid = DOC.createGRID("g30196415","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagesms_generallist.jsp'>
