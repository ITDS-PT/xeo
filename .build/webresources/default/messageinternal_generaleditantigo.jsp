...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messageinternal_generaleditantigo.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Mensagem Interna';</script>
                        ...
                        <TR>
                           <TD><%if (DOC.hasCategoryRights("settings")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_0" class="tab">
                                 <%{ int cvui12098282=DOCLIST.cvui;%>
                                 <%
BOI=currObjectList.getObject();sec = DOC.getSection("s29524544");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s29524544","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                                 ...
                                 <%DOCLIST.cvui=cvui12098282;}%>
                              </DIV>
                              <%}%>
                              <%if (DOC.hasCategoryRights("settingsRES")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_1" class="tab">
                                 <%{ int cvui16073449=DOCLIST.cvui;%>
                                 <%
BOI=currObjectList.getObject();sec = DOC.getSection("s33282494");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s33282494","");
  sec.p_name = "section_settingsRES";
  sec.p_id = "section_settingsRES";
sec.p_showLabel=false;
  bodef=boDefHandler.getBoDefinition("messageInternal");  sec.setTitle("");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                                 ...
                                 <%DOCLIST.cvui=cvui16073449;}%>
                              </DIV>
                              <%}%>
                              <%if (DOC.hasCategoryRights("options")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_2" class="tab">
                                 <%{ int cvui26510184=DOCLIST.cvui;%>
                                 <table>
                                    <tr height="60px">
                                       <td>
                                          <%
BOI=currObjectList.getObject();sec = DOC.getSection("s20924578");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s20924578","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                  ...
                  <%}%>
                  <%DOCLIST.cvui=cvui5461026;}%>
               </DIV>
               <%}%>
               <%if (DOC.hasCategoryRights("documents")){ %>
               <DIV id="barea_<%=DOCLIST.cvui%>_1" class="area">
                  <%{ int cvui19134669=DOCLIST.cvui;%>
                  ...
                  <%}%>
                  <%DOCLIST.cvui=cvui19134669;}%>
               </DIV>
               <%}%>
               <%if (DOC.hasCategoryRights("attachedObjects")){ %>
               <DIV id="barea_<%=DOCLIST.cvui%>_2" class="area">
                  <%{ int cvui26679986=DOCLIST.cvui;%>
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messageinternal_generaleditantigo.jsp'>
