...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_contact_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g17963561");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Contact");  grid = DOC.createGRID("g17963561","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_contact_generallist.jsp'>
