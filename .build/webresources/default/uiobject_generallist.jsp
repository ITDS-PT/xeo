...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=uiobject_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Object Gráfico';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g31439053");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("uiObject");  grid = DOC.createGRID("g31439053","");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='uiobject_generallist.jsp'>
