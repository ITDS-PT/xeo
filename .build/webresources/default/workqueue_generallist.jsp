...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=workqueue_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g6416243");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("workQueue");  grid = DOC.createGRID("g6416243","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='workqueue_generallist.jsp'>
