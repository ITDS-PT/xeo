...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitysend_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Enviar';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g6368299");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfActivitySend");  grid = DOC.createGRID("g6368299","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitysend_generallist.jsp'>
