...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=message_attachedobjects_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g16400146");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("message").getAttributeRef("attachedObjects").getBridge();  grid = DOC.createGRID("g16400146","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='message_attachedobjects_generallist.jsp'>
