...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfprogram_share_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g32275540");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfProgram").getAttributeRef("share").getBridge();  grid = DOC.createGRID("g32275540","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfprogram_share_generallist.jsp'>
