...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivityfill_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g23246001");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfActivityFill");  grid = DOC.createGRID("g23246001","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivityfill_generallist.jsp'>
