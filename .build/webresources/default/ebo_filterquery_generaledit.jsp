...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_filterquery_generaledit.jsp");
    return;
}
if(boctx==null) {
...
if ((BOI==null && securityRights.hasRights(boctx,"Ebo_FilterQuery")) || 
(BOI!=null && BOI.exists() && securityRights.hasRights(boctx,"Ebo_FilterQuery") && securityOPL.canRead(BOI)) || 
(BOI!=null && !BOI.exists() && securityRights.hasRights(boctx,"Ebo_FilterQuery",securityRights.ADD)) 
) {
if (BOI!=null && BOI.exists() && !BOI.isEnabledforRequest &&(!securityRights.hasRights(boctx,"Ebo_FilterQuery",securityRights.WRITE) ||  !securityOPL.canWrite(BOI) && !BOI.isEnabledforRequest)) { 
  BOI.setDisabled(); }
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_filterquery_generaledit.jsp'>
