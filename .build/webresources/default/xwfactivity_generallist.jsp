...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivity_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Tarefa';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g10945084");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfActivity");  grid = DOC.createGRID("g10945084","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivity_generallist.jsp'>
