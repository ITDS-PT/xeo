...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=horario_dia_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Tipos de  Dia';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g5014348");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("horario_dia");  grid = DOC.createGRID("g5014348","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='horario_dia_generallist.jsp'>
