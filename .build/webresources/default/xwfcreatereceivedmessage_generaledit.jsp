...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfcreatereceivedmessage_generaledit.jsp");
    return;
}
if(boctx==null) {
...
if ((BOI==null && securityRights.hasRights(boctx,"xwfCreateReceivedMessage")) || 
(BOI!=null && BOI.exists() && securityRights.hasRights(boctx,"xwfCreateReceivedMessage") && securityOPL.canRead(BOI)) || 
(BOI!=null && !BOI.exists() && securityRights.hasRights(boctx,"xwfCreateReceivedMessage",securityRights.ADD)) 
) {
if (BOI!=null && BOI.exists() && !BOI.isEnabledforRequest &&(!securityRights.hasRights(boctx,"xwfCreateReceivedMessage",securityRights.WRITE) ||  !securityOPL.canWrite(BOI) && !BOI.isEnabledforRequest)) { 
  BOI.setDisabled(); }
...
<title>
nbo «xwfCreateReceivedMessage»</title>
         ...
         <TR>
            <TD><%if (DOC.hasCategoryRights("settings")){ %>
               <DIV id="<%=DOCLIST.cvui%>_tabbody_0" class="tab" style="overflow-y:auto">
                  <%{ int cvui30733853=DOCLIST.cvui;%>
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s6945605");
if(sec != null)
  sec.setTitle("Assunto");
if(sec==null) { 
  sec = DOC.createSection("s6945605","");
  sec.p_name = "section_settingslabelActivity";
  sec.p_id = "section_settingslabelActivity";
sec.p_showLabel=false;
  bodef=boDefHandler.getBoDefinition("xwfCreateReceivedMessage");  sec.setTitle("Assunto");
  sec.p_height="20px";
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s32473520");
if(sec != null)
  sec.setTitle("Assunto");
if(sec==null) { 
  sec = DOC.createSection("s32473520","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s19619666");
if(sec != null)
  sec.setTitle("Descrição");
if(sec==null) { 
  sec = DOC.createSection("s19619666","");
  sec.p_name = "section_settingsDescActivity";
  sec.p_id = "section_settingsDescActivity";
  bodef=boDefHandler.getBoDefinition("xwfCreateReceivedMessage");  sec.setTitle("Descrição");
  sec.p_height="200px";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s8328866");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s8328866","");
  sec.p_name = "section_settingsActivity";
  sec.p_id = "section_settingsActivity";
sec.p_showLabel=false;
  bodef=boDefHandler.getBoDefinition("xwfCreateReceivedMessage");  sec.setTitle("");
  sec.p_height="20px";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s27720832");
if(sec != null)
  sec.setTitle(DOC.getCategoryLabel("general","settings.prvDatesAndTimes"));
if(sec==null) { 
  sec = DOC.createSection("s27720832","");
  sec.p_name = "section_prvDatas";
  sec.p_id = "section_prvDatas";
  bodef=boDefHandler.getBoDefinition("xwfCreateReceivedMessage");  sec.setTitle(DOC.getCategoryLabel("general","settings.prvDatesAndTimes"));
  sec.p_height="40px";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s745037");
if(sec != null)
  sec.setTitle(DOC.getCategoryLabel("general","settings.datesAndTimes"));
if(sec==null) { 
  sec = DOC.createSection("s745037","");
  sec.p_name = "section_datas";
  sec.p_id = "section_datas";
  bodef=boDefHandler.getBoDefinition("xwfCreateReceivedMessage");  sec.setTitle(DOC.getCategoryLabel("general","settings.datesAndTimes"));
  sec.p_height="80px";
  docHTML_sectionRow row; 
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfcreatereceivedmessage_generaledit.jsp'>
