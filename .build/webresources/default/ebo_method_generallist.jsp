...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_method_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Metodos';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g10815311");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Method");  grid = DOC.createGRID("g10815311","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_method_generallist.jsp'>
