...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=polloption_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Opção';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g13482339");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("PollOption");  grid = DOC.createGRID("g13482339","std");
  grid.setTitle();  
...
xattributes.put("width","100");grid.addColAtr(bodef.getAttributeRef("codeOption"),100,xattributes);
...
xattributes=new Hashtable();
xattributes.put("width","150");grid.addColAtr(bodef.getAttributeRef("labelOption"),150,xattributes);
}} //endCreategrid
...
<%}%>
<FORM name='boFormSubmit' method='post' action='polloption_generallist.jsp'>
