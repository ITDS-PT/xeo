...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_compartment_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Divisão';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g32332176");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Compartment");  grid = DOC.createGRID("g32332176","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_compartment_generallist.jsp'>
