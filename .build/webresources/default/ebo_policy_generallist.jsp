...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_policy_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Politica de Seguranca';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g8906505");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Policy");  grid = DOC.createGRID("g8906505","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_policy_generallist.jsp'>
