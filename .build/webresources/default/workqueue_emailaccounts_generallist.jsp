...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=workqueue_emailaccounts_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Pool de recursos';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g27414276");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("mailAccount");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("workQueue").getAttributeRef("emailAccounts").getBridge();  grid = DOC.createGRID("g27414276","std",true);
  grid.setTitle();  
...
xattributes.put("width","100");grid.addColBridgeAtr(bridgeDef.getAttributeRef("default"),100,xattributes);
} //endCreategrid
...
<%}%>
<FORM name='boFormSubmit' method='post' action='workqueue_emailaccounts_generallist.jsp'>
