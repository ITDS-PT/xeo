...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=process_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Processo';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g31158243");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("process");  grid = DOC.createGRID("g31158243","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='process_generallist.jsp'>
