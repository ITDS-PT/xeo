...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_application_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Aplicação';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g31694662");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Application");  grid = DOC.createGRID("g31694662","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_application_generallist.jsp'>
