...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfwaitresponse_generalcardid_list.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g11424605");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfWaitResponse");  grid = DOC.createGRID("g11424605","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfwaitresponse_generalcardid_list.jsp'>
