...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitychoice_variables_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g8454104");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVariable");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfActivityChoice").getAttributeRef("variables").getBridge();  grid = DOC.createGRID("g8454104","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitychoice_variables_generallist.jsp'>
