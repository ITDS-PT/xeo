...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_template_share_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g21661116");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("Ebo_Template").getAttributeRef("share").getBridge();  grid = DOC.createGRID("g21661116","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_template_share_generallist.jsp'>
