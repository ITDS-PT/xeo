...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=garbagecontroller_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Controlo Spam';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g12804327");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("garbageController");  grid = DOC.createGRID("g12804327","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='garbagecontroller_generallist.jsp'>
