...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitypoll_variables_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g32556378");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVariable");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfActivityPoll").getAttributeRef("variables").getBridge();  grid = DOC.createGRID("g32556378","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitypoll_variables_generallist.jsp'>
