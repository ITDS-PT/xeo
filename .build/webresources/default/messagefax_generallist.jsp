...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagefax_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g2178810");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("messageFax");  grid = DOC.createGRID("g2178810","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagefax_generallist.jsp'>
