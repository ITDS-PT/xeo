...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfwaitresponse_variables_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g24384222");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVariable");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfWaitResponse").getAttributeRef("variables").getBridge();  grid = DOC.createGRID("g24384222","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfwaitresponse_variables_generallist.jsp'>
