...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfcreatereceivedmessage_variables_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g15832730");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfVariable");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfCreateReceivedMessage").getAttributeRef("variables").getBridge();  grid = DOC.createGRID("g15832730","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfcreatereceivedmessage_variables_generallist.jsp'>
