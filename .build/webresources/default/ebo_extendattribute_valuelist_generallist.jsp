...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_extendattribute_valuelist_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g5192337");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("Ebo_ExtendAttribute").getAttributeRef("valueList").getBridge();  grid = DOC.createGRID("g5192337","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_extendattribute_valuelist_generallist.jsp'>
