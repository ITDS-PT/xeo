...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_filter_share_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g23361840");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("Ebo_Filter").getAttributeRef("share").getBridge();  grid = DOC.createGRID("g23361840","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_filter_share_generallist.jsp'>
