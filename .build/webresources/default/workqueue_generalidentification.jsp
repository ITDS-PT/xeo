...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=workqueue_generalidentification.jsp");
    return;
}
if(boctx==null) {
...
<%}%>
<FORM name='boFormSubmit' method='post' action='workqueue_generalidentification.jsp'>
