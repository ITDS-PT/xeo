...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfprogramdef_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g25454412");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfProgramDef");  grid = DOC.createGRID("g25454412","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfprogramdef_generallist.jsp'>
