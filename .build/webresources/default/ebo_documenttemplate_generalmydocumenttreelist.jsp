...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_documenttemplate_generalmydocumenttreelist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
boDefHandler xbodef = boDefHandler.getBoDefinition( "Ebo_DocumentTemplate");
docHTML_treeRuntime xtree=docHTML_treeServer.getTree(xbodef , xbodef.getPath("Viewers.general.forms.myDocumentTreeList.treeView"), DOC );
docHTML_treeView.render(xtree, pageContext ,DOC,DOCLIST );
%>
<script> window.gridKey='26509504'</script>  

</form>
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_documenttemplate_generalmydocumenttreelist.jsp'>
