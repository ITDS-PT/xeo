...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfprogram_owners_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g14064087");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("xwfProgram").getAttributeRef("owners").getBridge();  grid = DOC.createGRID("g14064087","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfprogram_owners_generallist.jsp'>
