...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_announce_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Anuncio';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g23383382");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Announce");  grid = DOC.createGRID("g23383382","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_announce_generallist.jsp'>
