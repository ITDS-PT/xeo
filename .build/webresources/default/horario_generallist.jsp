...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=horario_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g6543295");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("horario");  grid = DOC.createGRID("g6543295","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='horario_generallist.jsp'>
