...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_lovdetails_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  LOV item';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g29150104");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_LOVDetails");  grid = DOC.createGRID("g29150104","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_lovdetails_generallist.jsp'>
