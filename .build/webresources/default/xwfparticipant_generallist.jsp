...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfparticipant_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Participante';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g31945752");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfParticipant");  grid = DOC.createGRID("g31945752","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfparticipant_generallist.jsp'>
