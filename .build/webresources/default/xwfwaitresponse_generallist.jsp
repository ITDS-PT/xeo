...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfwaitresponse_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Esperar Resposta';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g25353671");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfWaitResponse");  grid = DOC.createGRID("g25353671","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfwaitresponse_generallist.jsp'>
