...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=pollrun_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g25153469");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("PollRun");  grid = DOC.createGRID("g25153469","std");
  grid.setTitle();  
} //endCreategrid
...
<%}%>
<FORM name='boFormSubmit' method='post' action='pollrun_generallist.jsp'>
