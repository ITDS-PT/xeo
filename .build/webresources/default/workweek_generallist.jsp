...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=workweek_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Horário de Trabalho';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g11628688");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("workweek");  grid = DOC.createGRID("g11628688","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='workweek_generallist.jsp'>
