...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=uiscreenpointer_share_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g6805511");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("uiScreenPointer").getAttributeRef("share").getBridge();  grid = DOC.createGRID("g6805511","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='uiscreenpointer_share_generallist.jsp'>
