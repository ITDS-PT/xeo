...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagereceipt_attachedobjects_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g2591766");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("messageReceipt").getAttributeRef("attachedObjects").getBridge();  grid = DOC.createGRID("g2591766","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagereceipt_attachedobjects_generallist.jsp'>
