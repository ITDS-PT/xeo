...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_group_emailaccounts_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Grupo de Trabalho';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g7905746");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("mailAccount");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("Ebo_Group").getAttributeRef("emailAccounts").getBridge();  grid = DOC.createGRID("g7905746","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_group_emailaccounts_generallist.jsp'>
