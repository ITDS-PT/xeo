...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitycreatemessage_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g7577057");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfActivityCreateMessage");  grid = DOC.createGRID("g7577057","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitycreatemessage_generallist.jsp'>
