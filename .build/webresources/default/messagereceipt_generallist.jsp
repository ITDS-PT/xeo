...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagereceipt_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g31775236");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("messageReceipt");  grid = DOC.createGRID("g31775236","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagereceipt_generallist.jsp'>
