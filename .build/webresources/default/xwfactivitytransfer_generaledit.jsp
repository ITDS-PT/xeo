...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfactivitytransfer_generaledit.jsp");
    return;
}
if(boctx==null) {
...
if ((BOI==null && securityRights.hasRights(boctx,"xwfActivityTransfer")) || 
(BOI!=null && BOI.exists() && securityRights.hasRights(boctx,"xwfActivityTransfer") && securityOPL.canRead(BOI)) || 
(BOI!=null && !BOI.exists() && securityRights.hasRights(boctx,"xwfActivityTransfer",securityRights.ADD)) 
) {
if (BOI!=null && BOI.exists() && !BOI.isEnabledforRequest &&(!securityRights.hasRights(boctx,"xwfActivityTransfer",securityRights.WRITE) ||  !securityOPL.canWrite(BOI) && !BOI.isEnabledforRequest)) { 
  BOI.setDisabled(); }
...
<%
String labelAux = "Transferir Processo";
%>
         ...
         <TR>
            <TD><%if (DOC.hasCategoryRights("settings")){ %>
               <DIV id="<%=DOCLIST.cvui%>_tabbody_0" class="tab" style="overflow-y:auto">
                  <%{ int cvui10330761=DOCLIST.cvui;%>
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s18471140");
if(sec != null)
  sec.setTitle("Assunto");
if(sec==null) { 
  sec = DOC.createSection("s18471140","");
  sec.p_name = "section_settingslabelActivity";
  sec.p_id = "section_settingslabelActivity";
sec.p_showLabel=false;
  bodef=boDefHandler.getBoDefinition("xwfActivityTransfer");  sec.setTitle("Assunto");
  sec.p_height="20px";
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s32411772");
if(sec != null)
  sec.setTitle("Assunto");
if(sec==null) { 
  sec = DOC.createSection("s32411772","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s22012886");
if(sec != null)
  sec.setTitle("Descrição");
if(sec==null) { 
  sec = DOC.createSection("s22012886","");
  sec.p_name = "section_settingsDescActivity";
  sec.p_id = "section_settingsDescActivity";
  bodef=boDefHandler.getBoDefinition("xwfActivityTransfer");  sec.setTitle("Descrição");
  sec.p_height="200px";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s32965788");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s32965788","");
  sec.p_name = "section_settingsActivity";
  sec.p_id = "section_settingsActivity";
sec.p_showLabel=false;
  bodef=boDefHandler.getBoDefinition("xwfActivityTransfer");  sec.setTitle("");
  sec.p_height="20px";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s5221141");
if(sec != null)
  sec.setTitle(DOC.getCategoryLabel("general","settings.prvDatesAndTimes"));
if(sec==null) { 
  sec = DOC.createSection("s5221141","");
  sec.p_name = "section_prvDatas";
  sec.p_id = "section_prvDatas";
  bodef=boDefHandler.getBoDefinition("xwfActivityTransfer");  sec.setTitle(DOC.getCategoryLabel("general","settings.prvDatesAndTimes"));
  sec.p_height="40px";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s6882400");
if(sec != null)
  sec.setTitle(DOC.getCategoryLabel("general","settings.datesAndTimes"));
if(sec==null) { 
  sec = DOC.createSection("s6882400","");
  sec.p_name = "section_datas";
  sec.p_id = "section_datas";
  bodef=boDefHandler.getBoDefinition("xwfActivityTransfer");  sec.setTitle(DOC.getCategoryLabel("general","settings.datesAndTimes"));
  sec.p_height="80px";
  docHTML_sectionRow row; 
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfactivitytransfer_generaledit.jsp'>
