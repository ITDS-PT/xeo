...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_package_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Pacote';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g16174292");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Package");  grid = DOC.createGRID("g16174292","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_package_generallist.jsp'>
