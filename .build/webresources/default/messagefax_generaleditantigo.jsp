...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=messagefax_generaleditantigo.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Fax';</script>
                        ...
                        <TR>
                           <TD><%if (DOC.hasCategoryRights("settings")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_0" class="tab">
                                 <%{ int cvui31996436=DOCLIST.cvui;%>
                                 <%
BOI=currObjectList.getObject();sec = DOC.getSection("s20781536");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s20781536","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                                 ...
                                 <%DOCLIST.cvui=cvui31996436;}%>
                              </DIV>
                              <%}%>
                              <%if (DOC.hasCategoryRights("settingsRES")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_1" class="tab">
                                 <%{ int cvui7201692=DOCLIST.cvui;%>
                                 <%
BOI=currObjectList.getObject();sec = DOC.getSection("s8013881");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s8013881","");
  sec.p_name = "section_settingsRES";
  sec.p_id = "section_settingsRES";
sec.p_showLabel=false;
  bodef=boDefHandler.getBoDefinition("messageFax");  sec.setTitle("");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                                 ...
                                 <%DOCLIST.cvui=cvui7201692;}%>
                              </DIV>
                              <%}%>
                              <%if (DOC.hasCategoryRights("options")){ %>
                              <DIV id="<%=DOCLIST.cvui%>_tabbody_2" class="tab">
                                 <%{ int cvui1818223=DOCLIST.cvui;%>
                                 <table>
                                    <tr height="60px">
                                       <td>
                                          <%
BOI=currObjectList.getObject();sec = DOC.getSection("s24348996");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s24348996","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%></td>
                  ...
                  <%}%>
                  <%DOCLIST.cvui=cvui29138179;}%>
               </DIV>
               <%}%>
               <%if (DOC.hasCategoryRights("documents")){ %>
               <DIV id="barea_<%=DOCLIST.cvui%>_1" class="area">
                  <%{ int cvui29224563=DOCLIST.cvui;%>
                  ...
                  <%}%>
                  <%DOCLIST.cvui=cvui29224563;}%>
               </DIV>
               <%}%>
               <%if (DOC.hasCategoryRights("attachedObjects")){ %>
               <DIV id="barea_<%=DOCLIST.cvui%>_2" class="area">
                  <%{ int cvui26077746=DOCLIST.cvui;%>
...
<%}%>
<FORM name='boFormSubmit' method='post' action='messagefax_generaleditantigo.jsp'>
