...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_attribute_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Atributos';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g31402366");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Attribute");  grid = DOC.createGRID("g31402366","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_attribute_generallist.jsp'>
