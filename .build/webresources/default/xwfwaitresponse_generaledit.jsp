...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfwaitresponse_generaledit.jsp");
    return;
}
if(boctx==null) {
...
if ((BOI==null && securityRights.hasRights(boctx,"xwfWaitResponse")) || 
(BOI!=null && BOI.exists() && securityRights.hasRights(boctx,"xwfWaitResponse") && securityOPL.canRead(BOI)) || 
(BOI!=null && !BOI.exists() && securityRights.hasRights(boctx,"xwfWaitResponse",securityRights.ADD)) 
) {
if (BOI!=null && BOI.exists() && !BOI.isEnabledforRequest &&(!securityRights.hasRights(boctx,"xwfWaitResponse",securityRights.WRITE) ||  !securityOPL.canWrite(BOI) && !BOI.isEnabledforRequest)) { 
  BOI.setDisabled(); }
...
<%
String labelAux = "Esperar Resposta";
%>
         ...
         <TR>
            <TD><%if (DOC.hasCategoryRights("settings")){ %>
               <DIV id="<%=DOCLIST.cvui%>_tabbody_0" class="tab" style="overflow-y:auto">
                  <%{ int cvui14888237=DOCLIST.cvui;%>
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s11213869");
if(sec != null)
  sec.setTitle("Assunto");
if(sec==null) { 
  sec = DOC.createSection("s11213869","");
  sec.p_name = "section_settingslabelActivity";
  sec.p_id = "section_settingslabelActivity";
sec.p_showLabel=false;
  bodef=boDefHandler.getBoDefinition("xwfWaitResponse");  sec.setTitle("Assunto");
  sec.p_height="20px";
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s29819914");
if(sec != null)
  sec.setTitle("Assunto");
if(sec==null) { 
  sec = DOC.createSection("s29819914","");
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s14305832");
if(sec != null)
  sec.setTitle("Descrição");
if(sec==null) { 
  sec = DOC.createSection("s14305832","");
  sec.p_name = "section_settingsDescActivity";
  sec.p_id = "section_settingsDescActivity";
  bodef=boDefHandler.getBoDefinition("xwfWaitResponse");  sec.setTitle("Descrição");
  sec.p_height="200px";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s20620609");
if(sec != null)
  sec.setTitle("");
if(sec==null) { 
  sec = DOC.createSection("s20620609","");
  sec.p_name = "section_settingsActivity";
  sec.p_id = "section_settingsActivity";
sec.p_showLabel=false;
  bodef=boDefHandler.getBoDefinition("xwfWaitResponse");  sec.setTitle("");
  sec.p_height="20px";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s20402190");
if(sec != null)
  sec.setTitle(DOC.getCategoryLabel("general","settings.prvDatesAndTimes"));
if(sec==null) { 
  sec = DOC.createSection("s20402190","");
  sec.p_name = "section_prvDatas";
  sec.p_id = "section_prvDatas";
  bodef=boDefHandler.getBoDefinition("xwfWaitResponse");  sec.setTitle(DOC.getCategoryLabel("general","settings.prvDatesAndTimes"));
  sec.p_height="40px";
  docHTML_sectionRow row; 
...
sec.render(pageContext,currObjectList,DOCLIST,DOC);%>
                  ...
                  <%
BOI=currObjectList.getObject();sec = DOC.getSection("s6883426");
if(sec != null)
  sec.setTitle(DOC.getCategoryLabel("general","settings.datesAndTimes"));
if(sec==null) { 
  sec = DOC.createSection("s6883426","");
  sec.p_name = "section_datas";
  sec.p_id = "section_datas";
  bodef=boDefHandler.getBoDefinition("xwfWaitResponse");  sec.setTitle(DOC.getCategoryLabel("general","settings.datesAndTimes"));
  sec.p_height="80px";
  docHTML_sectionRow row; 
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfwaitresponse_generaledit.jsp'>
