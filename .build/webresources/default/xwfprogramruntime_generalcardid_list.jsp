...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfprogramruntime_generalcardid_list.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g1557722");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfProgramRuntime");  grid = DOC.createGRID("g1557722","std");
  grid.setTitle();  
...
xattributes.put("width","50");}xattributes=new Hashtable();
xattributes.put("width","50");grid.addColSpecial("childObject.cardId",50,xattributes);
} //endCreategrid
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfprogramruntime_generalcardid_list.jsp'>
