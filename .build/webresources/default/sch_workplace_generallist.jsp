...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=sch_workplace_generallist.jsp");
    return;
}
if(boctx==null) {
...
<script>var objLabel='Lista de  Local de Trabalho';</script>
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g8315975");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Sch_workplace");  grid = DOC.createGRID("g8315975","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='sch_workplace_generallist.jsp'>
