...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_template_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g30135531");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Template");  grid = DOC.createGRID("g30135531","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_template_generallist.jsp'>
