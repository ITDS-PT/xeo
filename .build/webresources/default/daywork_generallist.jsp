...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=daywork_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g7285359");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("daywork");  grid = DOC.createGRID("g7285359","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='daywork_generallist.jsp'>
