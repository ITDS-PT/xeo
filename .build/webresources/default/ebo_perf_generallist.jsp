...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_perf_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g15824425");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Perf");  grid = DOC.createGRID("g15824425","std");
  grid.setTitle();  
...
xattributes=new Hashtable();
xattributes.put("width","55");grid.addColAtr(bodef.getAttributeRef("id"),55,xattributes);
}} //endCreategrid
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_perf_generallist.jsp'>
