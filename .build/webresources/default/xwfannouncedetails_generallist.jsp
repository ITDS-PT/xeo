...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=xwfannouncedetails_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g31247532");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("xwfAnnounceDetails");  grid = DOC.createGRID("g31247532","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='xwfannouncedetails_generallist.jsp'>
