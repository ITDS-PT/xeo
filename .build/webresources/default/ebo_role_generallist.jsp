...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_role_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   ...
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g12904385");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("Ebo_Role");  grid = DOC.createGRID("g12904385","std");
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_role_generallist.jsp'>
