...
if(bosession== null) {
    response.sendRedirect("login.jsp?returnPage=ebo_folder_details_generallist.jsp");
    return;
}
if(boctx==null) {
...
<form class="objectForm" name="boForm" id="<%=IDX%>">
   <%
BOI=currObjectList.getObject();grid = DOC.getGRID("g27185584");
if(grid==null) { 
  bodef=boDefHandler.getBoDefinition("boObject");  boDefBridge bridgeDef=boDefHandler.getBoDefinition("Ebo_Folder").getAttributeRef("details").getBridge();  grid = DOC.createGRID("g27185584","std",true);
  grid.setTitle();  
...
<%}%>
<FORM name='boFormSubmit' method='post' action='ebo_folder_details_generallist.jsp'>
