...
//    StringBuffer boql = new StringBuffer("SELECT xwfActivity STATE create WHERE program = ");
...
//    }
    ...
    newAct.append("&").append(ControllerFactory.CONTROLLER_NAME_KEY).append("=").append("XwfController");
    newAct.append("&boql=").append(boql.toString());
//    newAct.append("&onclick=").append(onclick);
    newAct.append("&userClick=").append(onclick);
    newAct.append("&userDblClick=window;");
    newAct.append("&canSelectRows=no");
    newAct.append("&lineColorState=create");
    newAct.append("&list_orderby=netgest.bo.runtime.sorter.ActivtiyDatesComparator");
...
<title></title>
<script language="javascript">var objLabel="&nbsp;&nbsp;Lista de Actividades Pendentes";</script>
</head>   
<body style="margin:0px">

<form style='height:100%;' class="objectForm" name="boForm" id="<%=IDX%>">
   <IFRAME src='<%=newAct.toString()%>' frameBorder=0 width='100%' scrolling=no height='100%' ></IFRAME> 
</form>
