...
try {
    ...
    String tempBoui = request.getParameter("tempBoui");
    ...
    if(!"".equals(tempBoui))
    {
        ...
        javaScriptStr=netgest.bo.impl.document.merge.gestemp.presentation.MapTempAtribTreeHelper.getJavaScriptTree( boctx , Long.parseLong(tempBoui));
