...
if(boctx==null) {
    ...
    String onclick = URLEncoder.encode(URLEncoder.encode("window('"+XwfKeys.ACTION_SHOW_KEY+"[OBJECT_LIST_BOUI]');parent.parent.boForm.BindValues();","UTF-8"),"UTF-8");

    String jspName = "xwfdefactivity_generallist.jsp?";
    
    StringBuffer boql = new StringBuffer("SELECT /*NO_SECURITY*/xwfDefActivity WHERE program = ");
...
<title></title>
<script>
    var objLabel="&nbsp;&nbsp;Lista de Actividades Concluídas";  
</script>
