...
// FCKeditor Class
var FCKeditor = function( instanceName, width, height, toolbarSet, value, AttParent, BouiParent, DOCid, ObjXeoName )
{
	// Properties
	this.attrParent		= AttParent;
	this.bouiParent		= BouiParent;
	this.docID 			= DOCid;
	this.objXeoName		= ObjXeoName;
