...
if(boctx==null) {
    ...
    boObject yes = activity.getAttribute("yes").getObject();
    boObject no = activity.getAttribute("no").getObject();
    
    StringBuffer result = new StringBuffer();
    if("".equals(answer))
    {
        result.append(yes.getAttribute("labelOption").getValueString()).append("&nbsp;/&nbsp;").append(no.getAttribute("labelOption").getValueString());
    }
    else
    {        
        if(answer.equals(yes.getAttribute("codeOption").getValueString()))
        {        
            result.append(yes.getAttribute("labelOption").getValueString());
        }
        else if(answer.equals(no.getAttribute("codeOption").getValueString()))
        {
            result.append(no.getAttribute("labelOption").getValueString());
        }
    }
